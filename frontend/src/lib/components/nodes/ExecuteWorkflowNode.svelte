...
>
	...
	<div class="mb-4 flex items-center gap-3">
		<div class="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-50 border border-gray-100 text-blue-600">
		...
		<div>
			...
			/>
			<div class="text-[10px] uppercase tracking-wider text-gray-500 mt-0.5">Sub-Workflow</div>
		</div>
	</div>
	...
	<div class="flex flex-col gap-3 rounded-lg bg-gray-50 border border-gray-100 p-3 nodrag">
		<div class="flex flex-col gap-1">
			<label class="text-[10px] font-bold uppercase tracking-wider text-gray-500 px-1" for="workflow-id-{id}">Workflow ID</label>
			<input id="workflow-id-{id}" type="text" bind:value={data.workflowId} class="w-full bg-white text-gray-800 text-xs p-2 rounded-md border border-gray-200 focus:border-blue-400 focus:ring-1 focus:ring-blue-400/20 outline-none shadow-sm" placeholder="uuid..." />
		</div>
		<ExpressionInput 
