...
<div class="relative bg-white w-64 p-4 rounded-xl text-left shadow-sm border border-gray-200 transition-all group hover:shadow-md hover:border-gray-300
	...
	<div class="flex items-center gap-3">
		...
		<div>
			<div class="text-[13px] font-bold text-gray-900 leading-tight">{data.label || 'Unknown Trigger'}</div>
			<div class="text-[10px] uppercase tracking-wider text-gray-500 mt-0.5">{data.typeLabel || 'Trigger'}</div>
		</div>
	</div>
	{#if data.description}
