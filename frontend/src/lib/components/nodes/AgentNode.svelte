...
<div
	...
	{data.status === 'running' ? '!border-purple-500 shadow-[0_0_15px_rgba(168,85,247,0.2)] dark:shadow-[0_0_20px_rgba(168,85,247,0.3)] animate-pulse' : ''}"
>
	<!-- Standard Input (Data) -->
	<Handle
		type="target"
	...
	<Handle
		...
		class="!w-4 !h-2 !rounded-sm !bg-yellow-400 !border-2 !border-white dark:!border-gray-900"
		id="tools"
	/>
	...
	<Handle
		...
		class="!w-3 !h-3 !bg-purple-500 !border-2 !border-white dark:!border-gray-900"
		id="main"
	/>
	...
	<div class="mb-4 flex items-center gap-3">
		<div class="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 text-purple-600 dark:text-purple-400">
			<!-- AI spark icon -->
		...
		<div>
			...
			/>
			<div class="text-[10px] uppercase tracking-wider text-purple-600 dark:text-purple-400 mt-0.5">AI Agent</div>
		</div>
	</div>
	...
	<div class="flex flex-col gap-3 rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 p-3 nodrag">
		<div class="flex flex-col gap-1">
			<label class="text-[10px] font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 px-1" for="system-prompt-{id}">System Prompt</label>
			<textarea
				id="system-prompt-{id}"
				bind:value={data.prompt}
				class="w-full bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 text-xs p-2 rounded-md border border-gray-200 dark:border-gray-700 focus:border-purple-400 dark:focus:border-purple-500 focus:ring-1 focus:ring-purple-400/20 outline-none resize-y min-h-16 shadow-sm"
			></textarea>
		</div>
		...
		<div class="flex flex-col gap-1 mt-1">
			<label class="text-[10px] font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 px-1" for="api-key-{id}">API Key</label>
			<input
				id="api-key-{id}"
				type="password"
				bind:value={data.apiKey}
				class="w-full bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 text-xs p-2 rounded-md border border-gray-200 dark:border-gray-700 focus:border-purple-400 dark:focus:border-purple-500 focus:ring-1 focus:ring-purple-400/20 outline-none shadow-sm"
				placeholder="sk-..."
			/>
		</div>
	</div>
