...
>
	...
	<div class="mb-4 flex items-center gap-3">
		...
		<div>
			...
			/>
			<div class="text-[10px] uppercase tracking-wider text-gray-500 dark:text-gray-400 mt-0.5">IF Condition</div>
		</div>
	</div>

	<!-- Configuration -->
	<div class="flex flex-col gap-3 rounded-lg bg-gray-50 dark:bg-gray-800 p-3 nodrag border border-gray-100 dark:border-gray-700">
		<ExpressionInput 
	...
	<Handle
		...
		class="!w-3 !h-3 !bg-emerald-500 !border-2 !border-white dark:!border-gray-900"
	/>
	<div class="absolute right-2 text-[10px] font-bold text-emerald-600 dark:text-emerald-400" style="top: 25%">true</div>
	...
	/>
	<div class="absolute right-2 text-[10px] font-bold text-red-600 dark:text-red-400" style="top: 65%">false</div>
