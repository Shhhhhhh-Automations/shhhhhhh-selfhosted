...
var Ee = (e, t, n) => Ws(e, typeof t != 'symbol' ? t + '' : t, n),
	pr = (e, t, n) => t.has(e) || Ao('Cannot ' + n);
var C = (e, t, n) => (pr(e, t, 'read from private field'), n ? n.call(e) : t.get(e)),
	B = (e, t, n) =>
		t.has(e)
			? Ao('Cannot add the same private member more than once')
			: t instanceof WeakSet
				? t.add(e)
				: t.set(e, n),
	sn = (e, t, n, r) => (pr(e, t, 'write to private field'), r ? r.call(e, n) : t.set(e, n), n),
	zo = (e, t, n) => (pr(e, t, 'access private method'), n);
...
import { b as En, p as G, s as It, c as io, r as Pt } from '../chunks/BQqSQ0fF.js';
import { o as Pa, a as sr } from '../chunks/D4x0b2LA.js';
import { a as Fe, e as gn, o as Lr, d as oo } from '../chunks/DA0K5guU.js';
...
import { b as br, c as Re, d as Se, f as se, a as Z, t as Zs } from '../chunks/pYZ6ss2q.js';
			...
			() => {
				if (s) {
					if ((s.pending.delete(h), s.done.add(h), s.pending.size === 0)) {
						var f = e.outrogroups;
						Vr(e, eo(s.done)), f.delete(s), f.size === 0 && (e.outrogroups = null);
					}
				} else i -= 1;
			},
			!1,
...
var Ho;
function so(e, t, n, r, o, s = null) {
	var i = e,
		a = new Map(),
		l = (t & Ei) !== 0;
	if (l) {
		var d = e;
		i = Je ? hn(Tt(d)) : d.appendChild(_r());
	}
	Je && Hr();
	var u = null,
		h = na(() => {
			var P = n();
			return ki(P) ? P : P == null ? [] : eo(P);
		}),
		f,
		g = new Map(),
		m = !0;
	...
	var S = Us(() => {
			...
			if (Je) {
				var R = Qs(i) === Js;
				R !== (P === 0) && ((i = To()), hn(i), kr(!1), (A = !0));
			}
			for (var L = new Set(), F = $s, U = ta(), Y = 0; Y < P; Y += 1) {
				Je && Ot.nodeType === Si && Ot.data === js && ((i = Ot), (A = !0), kr(!1));
				var $ = f[Y],
					M = r($, Y),
					p = m ? null : a.get(M);
				p
					? (p.v && Io(p.v, $), p.i && Io(p.i, Y), U && F.unskip_effect(p.e))
					: ((p = Ha(a, m ? i : (Ho ?? (Ho = _r())), $, M, Y, o, t, n)),
						m || (p.e.f |= et),
						a.set(M, p)),
					L.add(M);
			}
			if (
				(P === 0 &&
					s &&
					!u &&
					(m ? (u = Rr(() => s(i))) : ((u = Rr(() => s(Ho ?? (Ho = _r())))), (u.f |= et))),
				P > L.size && ea(),
				Je && P > 0 && hn(To()),
				!m)
			)
...
function Da(e, t, n, r, o) {
	...
	if (e.outrogroups !== null) {
		for (const z of e.outrogroups)
			z.pending.size === 0 && (Vr(e, eo(z.done)), (v = e.outrogroups) == null || v.delete(z));
		e.outrogroups.size === 0 && (e.outrogroups = null);
	}
	if (l !== null || d !== void 0) {
		var F = [];
		if (d !== void 0) for (w of d) w.f & Sr || F.push(w);
		for (; l !== null; ) !(l.f & Sr) && l !== e.fallback && F.push(l), (l = an(l.next));
		var U = F.length;
		if (U > 0) {
			...
			if (s) {
				...
				for (S = 0; S < U; S += 1) (I = (k = F[S].nodes) == null ? void 0 : k.a) == null || I.fix();
			}
			Oa(e, F, Y);
		}
	}
...
function Ha(e, t, n, r, o, s, i, a) {
	var l = i & oa ? (i & ia ? Oo(n) : sa(n, !1, !1)) : null,
		d = i & ra ? Oo(o) : null;
	return {
		v: l,
		i: d,
...
function ao(e, t, n = !1, r = !1, o = !1, s = !1) {
	var i = e,
		a = '';
	if (n) {
		var l = e;
	...
	ye(() => {
		...
		if (n && !Je) {
			(d.nodes = null), (l.innerHTML = a), a !== '' && br(Tt(l), l.lastChild);
			return;
		}
		if ((d.nodes !== null && (va(d.nodes.start, d.nodes.end), (d.nodes = null)), a !== '')) {
			if (Je) {
				Ot.data;
				for (var u = Hr(), h = u; u !== null && (u.nodeType !== Si || u.data !== ''); )
					(h = u), (u = Ni(u));
			...
			if ((br(Tt(m), m.lastChild), r || o)) for (; Tt(m); ) i.before(Tt(m));
			else i.before(m);
		}
	});
}
...
const ir = class ir {
	...
	observe(t, n) {
		...
		return (
			r.add(n),
			C(this, ht).set(t, r),
			zo(this, or, Di).call(this).observe(t, C(this, bn)),
			() => {
...
(ht = new WeakMap()),
	...
	Ee(ir, 'entries', new WeakMap());
const Kr = ir;
var Ra = new Kr({ box: 'border-box' });
function Ro(e, t, n) {
...
function Fa(e) {
	return function () {
		var t = this.ownerDocument,
			n = this.namespaceURI;
		return n === Br && t.documentElement.namespaceURI === Br
			? t.createElement(e)
...
function al(e, t, n, r, o, s) {
	for (var i = 0, a, l = t.length, d = s.length; i < d; ++i)
		(a = t[i]) ? ((a.__data__ = s[i]), (r[i] = a)) : (n[i] = new Zn(e, s[i]));
...
function ll(e, t, n, r, o, s, i) {
	...
	for (a = 0; a < h; ++a)
		(g = i.call(e, s[a], a, s) + ''),
			(l = d.get(g)) ? ((r[a] = l), (l.__data__ = s[a]), d.delete(g)) : (n[a] = new Zn(e, s[a]));
...
function ul(e, t) {
	...
	for (var s = o.length, i = new Array(s), a = new Array(s), l = new Array(s), d = 0; d < s; ++d) {
		var u = r[d],
			...
			S = (l[d] = new Array(f));
		n(u, h, x, w, S, g, t);
		for (var O = 0, P = 0, A, R; O < m; ++O)
			if ((A = x[O])) {
				for (O >= P && (P = O + 1); !(R = w[P]) && ++P < m; );
				A._next = R || null;
			}
	}
...
function Xi(e, t) {
	for (var n = co(e), r = -1, o = t.length; ++r < o; ) n.add(t[r]);
}
function Wi(e, t) {
	for (var n = co(e), r = -1, o = t.length; ++r < o; ) n.remove(t[r]);
}
function Vl(e) {
	return function () {
		Xi(this, e);
...
function Fl(e, t) {
	var n = Fi(e + '');
	if (arguments.length < 2) {
		for (var r = co(this.node()), o = -1, s = n.length; ++o < s; ) if (!r.contains(n[o])) return !1;
		return !0;
	}
...
function rc(e, t) {
	var n = typeof e == 'function' ? e : Hi(e),
		r = t == null ? nc : typeof t == 'function' ? t : lo(t);
	return this.select(function () {
...
function Cc() {
	...
	function g(A, R) {
		if (!(u || !e.call(this, A, R))) {
			var L = P(this, t.call(this, A, R), A, R, 'mouse');
			L &&
	...
	function w(A, R) {
		if (e.call(this, A, R)) {
			var L = A.changedTouches,
				...
				$;
			for (Y = 0; Y < U; ++Y)
				($ = P(this, F, A, R, L[Y].identifier, L[Y])) && (Er(A), $('start', A, L[Y]));
		}
	}
	function S(A) {
		var R = A.changedTouches,
			...
			F,
			U;
		for (F = 0; F < L; ++F) (U = o[R[F].identifier]) && (Ht(A), U('drag', A, R[F]));
	}
	function O(A) {
		var R = A.changedTouches,
			L = R.length,
		...
		for (
			...
			(U = o[R[F].identifier]) && (Er(A), U('end', A, R[F]));
	}
	function P(A, R, L, F, U, Y) {
		var $ = s.copy(),
			M = Qe(Y || L, R),
			p,
			N,
...
uo(
	...
	Qi(Mn, {
		brighter(e) {
			return (
				(e = e == null ? qn : qn ** e), new Oe(this.r * e, this.g * e, this.b * e, this.opacity)
			);
		},
		darker(e) {
			return (
		...
		clamp() {
			return new Oe(_t(this.r), _t(this.g), _t(this.b), Gn(this.opacity));
		},
		displayable() {
			return (
				-0.5 <= this.r &&
...
uo(
	...
	Qi(Mn, {
		brighter(e) {
			return (e = e == null ? qn : qn ** e), new We(this.h, this.s, this.l * e, this.opacity);
		},
		darker(e) {
		...
		rgb() {
			var e = (this.h % 360) + (this.h < 0) * 360,
				...
				o = 2 * n - r;
			return new Oe(
				Cr(e >= 240 ? e - 240 : e + 120, o, r),
				Cr(e, o, r),
				Cr(e < 120 ? e + 240 : e - 120, o, r),
				this.opacity,
			);
		},
		clamp() {
			return new We(Go(this.h), On(this.s), On(this.l), Gn(this.opacity));
		},
		displayable() {
			return (
...
function Bc(e) {
	return (e = +e) == 1 ? ji : (t, n) => (n - t ? Kc(t, n, e) : fo(isNaN(t) ? n : t));
}
function ji(e, t) {
	var n = t - e;
	return n ? Vc(e, n) : fo(isNaN(e) ? t : e);
}
const Un = (function e(t) {
	var n = Bc(t);
	function r(o, s) {
		var i = n((o = Yr(o)).r, (s = Yr(s)).r),
			a = n(o.g, s.g),
			l = n(o.b, s.b),
...
function $i(e, t) {
	var n = (Xr.lastIndex = Mr.lastIndex = 0),
		r,
		o,
		s,
		i = -1,
		a = [],
		l = [];
	for (e = e + '', t = t + ''; (r = Xr.exec(e)) && (o = Mr.exec(t)); )
...
function Uc(e) {
	...
	return t.isIdentity ? Wr : es(t.a, t.b, t.c, t.d, t.e, t.f);
}
function Qc(e) {
	return e == null ||
		...
		if (x < $c)
			...
			(S = (L - R) / t),
				(w = (F) => {
					var U = F * S,
						Y = Qo(R),
						$ = (d / (n * O)) * (Y * tu(t * U + R) - eu(R));
					return [a + $ * g, l + $ * m, (d * Y) / Qo(t * U + R)];
				});
		}
...
jn.prototype = os.prototype = {
	...
	restart: function (e, t, n) {
		...
		(n = (n == null ? ho() : +n) + (t == null ? 0 : +t)),
			!this._next && fn !== this && (fn ? (fn._next = this) : (Qn = this), (fn = this)),
			(this._call = e),
			(this._time = n),
			Zr();
	},
...
function ru() {
	ho(), ++Ft;
	for (var e = Qn, t; e; ) (t = St - e._time) >= 0 && e._call.call(void 0, t), (e = e._next);
	--Ft;
}
function Jo() {
	(St = (Jn = xn.now()) + ur), (Ft = dn = 0);
	try {
		ru();
	} finally {
		(Ft = 0), iu(), (St = 0);
...
function iu() {
	for (var e, t = Qn, n, r = 1 / 0; t; )
		t._call
			? (r > t._time && (r = t._time), (e = t), (t = t._next))
			: ((n = t._next), (t._next = null), (t = e ? (e._next = n) : (Qn = n)));
	(fn = e), Zr(r);
}
function Zr(e) {
	if (!Ft) {
		...
		var t = e - St;
		t > 24
			? (e < 1 / 0 && (dn = setTimeout(Jo, e - xn.now() - ur)), ln && (ln = clearInterval(ln)))
			: (ln || ((Jn = xn.now()), (ln = setInterval(ou, ns))), (Ft = 1), rs(Jo));
	}
}
function jo(e, t, n) {
	var r = new jn();
...
var su = lr('start', 'end', 'cancel', 'interrupt'),
	au = [],
	is = 0,
	$o = 1,
	qr = 2,
		...
		for (
			var u =
					d < n.duration
						...
						: (n.timer.restart(l), (n.state = Gr), 1),
				h = -1,
				f = o.length;
			++h < f;
		)
			o[h].call(e, u);
		n.state === Gr && (n.on.call('end', e, e.__data__, n.index, n.group), l());
	}
	function l() {
...
function ss(e, t) {
	var n;
	return (typeof t == 'number' ? je : t instanceof kt ? Un : (n = kt(t)) ? ((t = n), Un) : $i)(
		e,
		t,
	);
}
...
function xu(e, t) {
	...
	return this.attrTween(
		e,
		typeof t == 'function'
			? (n.local ? wu : mu)(n, r, vo(this, 'attr.' + e, t))
			: t == null
				? (n.local ? gu : hu)(n)
				: (n.local ? yu : vu)(n, r, t),
	);
	...
	for (var r = this._groups, o = r.length, s = new Array(o), i = 0; i < o; ++i)
		for (var a = r[i], l = a.length, d = (s[i] = new Array(l)), u, h, f = 0; f < l; ++f)
			(u = a[f]) &&
				...
				('__data__' in u && (h.__data__ = u.__data__), (d[f] = h), dr(d[f], t, n, f, d, Ge(u, n)));
...
function Qu(e, t, n) {
	...
	return t == null
		...
		: typeof t == 'function'
			? this.styleTween(e, Gu(e, r, vo(this, 'style.' + e, t))).each(Uu(this._id, e))
...
function nd(e) {
	return this.tween(
		'text',
		typeof e == 'function' ? td(vo(this, 'text', e)) : ed(e == null ? '' : e + ''),
	);
}
function rd(e) {
	return function (t) {
...
function fd(e) {
	...
	e instanceof lt
		? ((t = e._id), (e = e._name))
		: ((t = ls()), ((n = ud).time = ho()), (e = e == null ? null : e + ''));
	for (var r = this._groups, o = r.length, s = 0; s < o; ++s)
		for (var i = r[s], a = i.length, l, d = 0; d < a; ++d)
			(l = i[d]) && dr(l, e, t, d, i, n || dd(l, t));
...
function xd() {
			...
			S.transform(
				...
				function () {
					var I = t.apply(this, arguments),
						...
						K = z.invert(T),
						q = typeof E == 'function' ? E.apply(this, arguments) : E;
					return n(P(O(z, q), T, K), I, i);
				},
				y,
				k,
			);
		...
		v.on('start.zoom', function () {
			...
			.tween('zoom', function () {
				var z = arguments,
					T = L(this, z).event(k),
					K = t.apply(this, z),
					q = y == null ? A(K) : typeof y == 'function' ? y.apply(this, z) : y,
					W = Math.max(K[1][0] - K[0][0], K[1][1] - K[0][1]),
					X = this.__zoom,
					j = typeof E == 'function' ? E.apply(this, z) : E,
					D = l(X.invert(q).concat(W / X.k), j.invert(q).concat(W / j.k));
				return (V) => {
					if (V === 1) V = j;
					else {
						var Q = D(V),
							ie = W / Q[2];
						V = new it(ie, q[0] - Q[0] * ie, q[1] - Q[1] * ie);
					}
					T.zoom(null, V);
				};
			});
	...
	function Y(v, ...E) {
		...
		var y = v.currentTarget,
			k = L(this, E, !0).event(v),
			I = Xe(v.view).on('mousemove.zoom', q, !0).on('mouseup.zoom', W, !0),
			z = Qe(v, y),
			T = v.clientX,
			K = v.clientY;
		Gi(v.view), Nr(v), (k.mouse = [z, this.__zoom.invert(z)]), Xn(this), k.start();
		function q(X) {
			if ((cn(X), !k.moved)) {
				var j = X.clientX - T,
					D = X.clientY - K;
	...
	function $(v, ...E) {
		if (e.apply(this, arguments)) {
			...
			cn(v),
				a > 0
					? Xe(this).transition().duration(a).call(R, T, k, v)
	...
	function M(v, ...E) {
		if (e.apply(this, arguments)) {
			var y = v.touches,
				k = y.length,
				I = L(this, E, v.changedTouches.length === k).event(v),
				z,
				T,
				K,
				q;
			for (Nr(v), T = 0; T < k; ++T)
				(K = y[T]),
					(q = Qe(K, this)),
					(q = [q, this.__zoom.invert(q), K.identifier]),
					I.touch0
						? !I.touch1 && I.touch0[2] !== q[2] && ((I.touch1 = q), (I.taps = 0))
						: ((I.touch0 = q), (z = !0), (I.taps = 1 + !!u));
			u && (u = clearTimeout(u)),
				z &&
					(I.taps < 2 &&
						((h = q[0]),
		...
		if (this.__zooming) {
			...
			if (((T = y.that.__zoom), y.touch1)) {
				var W = y.touch0[0],
					...
					j = y.touch1[0],
					D = y.touch1[1],
					V = (V = j[0] - W[0]) * V + (V = j[1] - W[1]) * V,
					Q = (Q = D[0] - X[0]) * Q + (Q = D[1] - X[1]) * Q;
				(T = O(T, Math.sqrt(V / Q))),
					(K = [(W[0] + j[0]) / 2, (W[1] + j[1]) / 2]),
					(q = [(X[0] + D[0]) / 2, (X[1] + D[1]) / 2]);
			} else if (y.touch0) (K = y.touch0[0]), (q = y.touch0[1]);
			else return;
			y.zoom('touch', n(P(T, K, q), y.extent, i));
		}
	}
	function N(v, ...E) {
		if (this.__zooming) {
...
const ds = (e) => 'id' in e && 'source' in e && 'target' in e,
	...
	yo = (e) => 'id' in e && 'internals' in e && !('source' in e) && !('target' in e),
	Nn = (e, t = [0, 0]) => {
	...
	Sd = (e, t = { nodeOrigin: [0, 0] }) => {
		...
		const n = e.reduce(
			(r, o) => {
				...
				t.nodeLookup && (i = s ? t.nodeLookup.get(o) : yo(o) ? o : t.nodeLookup.get(o.id));
				const a = i ? tr(i, t.nodeOrigin) : { x: 0, y: 0, x2: 0, y2: 0 };
				return gr(r, a);
			},
	...
	hr = (e, t = {}) => {
		...
		return (
			e.forEach((o) => {
				(t.filter === void 0 || t.filter(o)) && ((n = gr(n, tr(o))), (r = !0));
			}),
			r ? vr(n) : { x: 0, y: 0, width: 0, height: 0 }
		);
	},
	mo = (e, t, [n, r, o] = [0, 0, 1], s = !1, i = !1) => {
...
const oi = (e, t, n) =>
	...
	Jr = ({ x: e, y: t, width: n, height: r }) => ({ x: e, y: t, x2: e + n, y2: t + r }),
	vr = ({ x: e, y: t, x2: n, y2: r }) => ({ x: e, y: t, width: n - e, height: r - t }),
	Wt = (e, t = [0, 0]) => {
		var o, s;
		const { x: n, y: r } = yo(e) ? e.internals.positionAbsolute : Nn(e, t);
		return {
			x: n,
			y: r,
...
function Pr(e, { snapGrid: t = [0, 0], snapToGrid: n = !1, transform: r, containerBounds: o }) {
	const { x: s, y: i } = Ze(e),
		a = Ut(
...
function Yd({
	...
	if (a[f] * l[f] === -1) {
		...
		a[f] === g ? (m = f === 'x' ? U : Y) : (m = f === 'x' ? Y : U);
	} else {
		const U = [{ x: d.x, y: u.y }],
			Y = [{ x: u.x, y: d.y }];
		if ((f === 'x' ? (m = a.x === g ? Y : U) : (m = a.y === g ? U : Y), t === r)) {
...
function Jd(e, t, n, r = {}) {
	...
	const o = _o(Gd, r),
		s = { i: 0 },
		i = new Map(t),
		a = o != null && o.elevateNodesOnSelect && !ko(o.zIndexMode) ? _s : 0;
	let l = e.length > 0,
		d = !1;
	t.clear(), n.clear();
	for (const f of e) {
...
function So(e, t, n, r, o) {
	const { elevateNodesOnSelect: s, nodeOrigin: i, nodeExtent: a, zIndexMode: l } = _o(bo, r),
		d = e.parentId,
		u = t.get(d);
	if (!u) {
		console.warn(
...
function ks(e, t, n) {
	...
	return ko(n) ? r : r + (e.selected ? t : 0);
}
...
function tf(e, t, n, r, o, s, i) {
	...
	for (const g of e.values()) {
		...
		if (x.width && x.height && (w || !m.internals.handleBounds || g.force)) {
			...
			t.set(m.id, R),
				m.parentId && So(R, t, n, { nodeOrigin: o, zIndexMode: i }),
				(l = !0),
				w &&
					(d.push({ id: m.id, type: 'dimensions', dimensions: x }),
					m.expandParent &&
						m.parentId &&
						f.push({ id: m.id, parentId: m.parentId, rect: Wt(R, o) }));
		}
	}
	if (f.length > 0) {
		const g = ef(f, t, n, o);
...
function Ar({ nodeId: e, dragItems: t, nodeLookup: n, dragging: r = !0 }) {
	var i, a, l;
	const o = [];
	for (const [d, u] of t) {
...
function af({ onNodeMouseDown: e, getStoreItems: t, onDragStart: n, onDrag: r, onDragStop: o }) {
	...
	function w({
		...
		function U({ x: p, y: N }) {
			...
			const X = a.size > 1,
				j = X && E ? Jr(hr(a)) : null,
				D = X && k ? sf({ dragItems: a, snapGrid: y, x: p, y: N }) : null;
			for (const [V, Q] of a) {
				if (!v.has(V)) continue;
				let ie = { x: p - Q.distance.x, y: N - Q.distance.y };
				k && (ie = D ? { x: Math.round(ie.x + D.x), y: Math.round(ie.y + D.y) } : Pn(ie, y));
				let ge = null;
				if (X && E && !Q.extent && j) {
					const { positionAbsolute: ue } = Q.internals,
						pe = ue.x - j.x + E[0][0],
						ze = ue.x + Q.measured.width - j.x2 + E[1][0],
						Te = ue.y - j.y + E[0][1],
						Ne = ue.y + Q.measured.height - j.y2 + E[1][1];
					ge = [
						[pe, Te],
						[ze, Ne],
					];
				...
				(W = W || Q.position.x !== re.x || Q.position.y !== re.y),
					(Q.position = re),
					(Q.internals.positionAbsolute = we);
			}
			if (((m = m || W), !!W && (q(a, !0), x && (r || z || (!L && T))))) {
				const [V, Q] = Ar({ nodeId: L, dragItems: a, nodeLookup: v });
				r == null || r(x, a, V, Q), z == null || z(x, V, Q), L || T == null || T(x, Q);
			}
		}
		async function Y() {
			if (!u) return;
		...
		function $(p) {
			...
			(h = !0),
				(!z || !R) && !v && L && (((X = N.get(L)) != null && X.selected) || q()),
				R && z && L && (e == null || e(L));
			const W = Pr(p.sourceEvent, { transform: y, snapGrid: k, snapToGrid: I, containerBounds: u });
			if (((s = W), (a = of(N, E, W, L)), a.size > 0 && (n || T || (!L && K)))) {
				const [j, D] = Ar({ nodeId: L, dragItems: a, nodeLookup: N });
				n == null || n(p.sourceEvent, a, j, D),
					T == null || T(p.sourceEvent, j, D),
					L || K == null || K(p.sourceEvent, D);
			}
		}
		const M = Cc()
			.clickDistance(F)
			.on('start', (p) => {
				...
				(u = (N == null ? void 0 : N.getBoundingClientRect()) || null),
					...
					(x = p.sourceEvent),
					v === 0 && $(p),
					(s = Pr(p.sourceEvent, { transform: E, snapGrid: y, snapToGrid: k, containerBounds: u })),
			...
			.on('drag', (p) => {
				const {
					...
					z = Pr(p.sourceEvent, { transform: v, snapGrid: E, snapToGrid: y, containerBounds: u });
				if (
					((x = p.sourceEvent),
					...
					if ((!l && N && h && ((l = !0), Y()), !h)) {
						const T = Ze(p.sourceEvent, u),
							K = T.x - d.x,
							q = T.y - d.y;
						Math.sqrt(K * K + q * q) > k && $(p);
					}
					(s.x !== z.xSnapped || s.y !== z.ySnapped) &&
						a &&
						h &&
						((d = Ze(p.sourceEvent, u)), U(z));
				}
			})
			.on('end', (p) => {
				if (!h || g) {
				...
				if (((l = !1), (h = !1), cancelAnimationFrame(i), a.size > 0)) {
					...
					if ((m && (v(a, !1), (m = !1)), o || E || (!L && y))) {
						const [k, I] = Ar({ nodeId: L, dragItems: a, nodeLookup: N, dragging: !1 });
...
function ff(
	...
	function W() {
		if (!u || !E) return;
		const [re, we] = wo(I, E, L);
		f({ x: re, y: we }), ($ = requestAnimationFrame(W));
	}
	...
	function Q() {
		(y = !0), P(V), m == null || m(e, { nodeId: o, handleId: r, handleType: v });
	}
	F === 0 && Q();
	function ie(re) {
		if (!y) {
		...
		const we = A();
		(I = Ze(re, E)), (M = uf(Ut(I, we, !1, [1, 1]), n, l, X)), z || (W(), (z = !0));
		const ue = Ns(re, {
			handle: M,
			connectionMode: t,
			fromNodeId: o,
		...
		(q = ue.handleDomNode), (T = ue.connection), (K = df(!!M, ue.isValid));
		const pe = l.get(o),
			ze = pe ? Mt(pe, X, ne.Left, !0) : V.from,
			Te = {
				...V,
				from: ze,
				isValid: K,
	...
	function ge(re) {
		if (!('touches' in re && re.touches.length > 0)) {
			if (y) {
				(M || q) && T && K && (x == null || x(T));
				const { inProgress: we, ...ue } = V,
					pe = { ...ue, toPosition: V.toHandle ? V.toPosition : null };
...
function Ns(
	...
	if (w) {
		const O = Cs(void 0, w),
			...
			R = w.classList.contains('connectable'),
...
const vi = { onPointerDown: ff, isValid: Ns },
	yr = (e) => ({ x: e.x, y: e.y, zoom: e.k }),
	zr = ({ x: e, y: t, zoom: n }) => fr.translate(e, t).scale(n),
...
function gf({
	...
	return (u) => {
		...
		!nr() && u.shiftKey && o !== Lt.Vertical && ((g = u.deltaY * f), (m = 0)),
			r.translateBy(n, -(g / h) * s, -(m / h) * s, { internal: !0 });
		const x = yr(n.property('__zoom'));
	...
	return (s) => {
		...
		(e.usedRightMouseButton = !!(n && Ps(t, e.mouseButton ?? 0))),
			...
			o &&
				...
				(o == null || o(s.sourceEvent, yr(s.transform)));
	};
}
function wf({
	zoomPanValues: e,
...
function pf({
			...
			? new Promise((N) => {
					h == null ||
						h.interpolate((p == null ? void 0 : p.interpolate) === 'linear' ? vn : Bn).transform(
							Tr(f, p == null ? void 0 : p.duration, p == null ? void 0 : p.ease, () => N(!0)),
							M,
						);
				})
			: !1;
	...
	function w({
		...
		const ie = E && !W && !v;
		h.clickDistance(Q ? 1 / 0 : !st(V) || V < 0 ? 0 : V);
		const ge = ie
			? gf({
					zoomPanValues: d,
					noWheelClassName: M,
		...
		h.filter(pe), q ? f.on('dblclick.zoom', m) : f.on('dblclick.zoom', null);
	}
	function S() {
		h.on('zoom', null);
	}
...
function Nt(e, t) {
	le(t, !0);
	const n = G(t, 'id', 3, null),
		r = G(t, 'type', 3, 'source'),
		o = G(t, 'position', 19, () => ne.Top),
		s = G(t, 'isConnectableStart', 3, !0),
		i = G(t, 'isConnectableEnd', 3, !0),
		a = Pt(t, Pf);
	...
	function U(p) {
		...
		if (!f.clickConnectStartHandle) {
			(q = f.onclickconnectstart) == null ||
				q.call(f, p, { nodeId: l, handleId: n(), handleType: r() }),
		...
		delete K.inProgress,
			...
			(W = f.onclickconnectend) == null || W.call(f, p, K),
	...
	yt(Y, () => ({
		...
		onmousedown: F,
		ontouchstart: F,
		onclick: f.clickConnect ? U : void 0,
		onkeypress: $,
		style: t.style,
		role: 'button',
	...
	var M = ee(Y);
	Ye(M, () => t.children ?? Gt), J(Y), Z(e, Y), ce();
}
var zf = se('<!> <!>', 1);
function zs(e, t) {
	le(t, !0);
	const n = G(t, 'targetPosition', 19, () => ne.Top),
		r = G(t, 'sourcePosition', 19, () => ne.Bottom);
	var o = zf(),
		s = me(o);
	Nt(s, {
		type: 'target',
...
function If(e, t) {
	le(t, !0);
	const n = G(t, 'data', 19, () => ({ label: 'Node' })),
		r = G(t, 'sourcePosition', 19, () => ne.Bottom);
	$e();
	var o = Tf(),
		s = me(o),
...
function Df(e, t) {
	le(t, !0);
	const n = G(t, 'data', 19, () => ({ label: 'Node' })),
		r = G(t, 'targetPosition', 19, () => ne.Top);
	$e();
	var o = Of(),
		s = me(o),
		i = te(s);
...
function Bf(e, t) {
	...
	const n = G(t, 'x', 3, 0),
		r = G(t, 'y', 3, 0),
		o = G(t, 'selectEdgeOnClick', 3, !1),
		s = G(t, 'transparent', 3, !1),
		i = Pt(t, Vf);
	const a = Qt(),
...
function mr(e, t) {
	const n = G(t, 'interactionWidth', 3, 20),
		r = Pt(t, Ff);
	var o = Xf(),
		s = me(o),
		i = te(s);
	...
	ye(() => {
		be(s, 'id', t.id),
			be(s, 'd', t.path),
			vt(s, 0, ro(['svelte-flow__edge-path', t.class])),
...
function jf(e, t, n, r) {
	const o = new Map();
	return (
		mo(e, { x: 0, y: 0, width: n, height: r }, t, !0).forEach((s) => {
			o.set(s.id, s);
		}),
		o
	);
		...
		constructor() {
			...
			B(
				...
				b(() => {
					...
					if (Bs) {
						const { viewport: xr, width: Mo, height: No } = this,
							Po = [xr.x, xr.y, xr.zoom];
						(An = jf(Ke, Po, Mo, No)),
							(wr = wi({
								...Co,
								onlyRenderVisible: !0,
					...
					} else (An = this.nodeLookup), (wr = wi(Co));
					return { nodes: An, edges: wr };
				}),
			);
			B(
				this,
			...
			B(
				this,
				F,
				b(() => e.props.nodeExtent ?? Ur),
			);
			B(
				this,
				U,
				b(() => e.props.translateExtent ?? Ur),
			);
			B(
				this,
				Y,
			...
			B(
				this,
				D,
				b(() => e.props.selectionMode ?? $n.Partial),
			);
			B(
				this,
				V,
...
function rh(e) {
	...
	function R(M, p) {
		...
		for (const X of y.values()) {
			...
			let D = { x: X.internals.positionAbsolute.x + q, y: X.internals.positionAbsolute.y + W };
			v && (D = Pn(D, v));
			const { position: V, positionAbsolute: Q } = fs({
				nodeId: X.id,
				nextPosition: D,
				nodeLookup: y,
				nodeExtent: N,
			...
			(X.position = V), (X.internals.positionAbsolute = Q), z.set(X.id, X);
		}
		s(z);
	}
	function L(M) {
...
function ah(e, t) {
	...
	let n = G(t, 'store', 15),
		r = G(t, 'panOnDrag', 3, !0),
		o = G(t, 'paneClickDistance', 3, 1),
		s = G(t, 'autoPanOnSelection', 3, !0),
		i,
		a = null,
		l = new Set(),
		d = new Set(),
	...
	function S(y) {
		...
		(X = (W = y.target) == null ? void 0 : W.setPointerCapture) == null || X.call(W, y.pointerId),
			(g = !1),
			(w = !1);
		const { x: T, y: K } = Ze(y, a),
			q = Ut({ x: T, y: K }, [n().viewport.x, n().viewport.y, n().viewport.zoom]);
		n((n().selectionRect = { width: 0, height: 0, startX: q.x, startY: q.y, x: T, y: K }), !0),
	...
	function O(y, k) {
		...
		const I = {
				...
				y: (D = n().selectionRect) == null ? void 0 : D.startY,
			},
		...
		d = new Set();
		for (const V of l) {
			const Q = n().connectionLookup.get(V);
			if (Q)
				for (const { edgeId: ie } of Q.values()) {
					const ge = n().edgeLookup.get(ie);
					ge && (ge.selectable ?? W) && d.add(ie);
				}
		}
		bi(K, l) || n((n().nodes = n().nodes.map(pi(l))), !0),
			bi(q, d) || n((n().edges = n().edges.map(pi(d))), !0),
			n((n().selectionRectMode = 'user'), !0),
			n((n().selectionRect = T), !0);
	}
	function P() {
		if (!s() || !a) return;
		const [y, k] = wo(x, a, n().autoPanSpeed);
		n()
			.panBy({ x: y, y: k })
			.then((I) => {
				if (!g || !I) {
	...
	Ye(E, () => t.children),
		...
		Fe('pointermove', M, function (...y) {
			var k;
			(k = c(f) ? R : void 0) == null || k.apply(this, y);
		}),
...
function vh(e, t) {
	...
	const n = G(t, 'store', 15),
		...
		R = b(() => t.node.initialHeight),
		L = b(() => t.node.width),
		F = b(() => t.node.height),
		U = b(() => t.node.dragHandle),
	...
	Sf(N), Cf(ge);
	const re = b(() => {
		const oe = c(O) === void 0 ? (c(L) ?? c(A)) : c(L),
			he = c(P) === void 0 ? (c(F) ?? c(R)) : c(F);
	...
	at(() => {
		(c(m) !== j || c(w) !== D || c(S) !== V) &&
			...
			requestAnimationFrame(() => {
				c(W) !== null &&
					n().updateNodeInternals(new Map([[N, { id: N, nodeElement: c(W), force: !0 }]]));
			}),
			(j = c(m)),
			(D = c(w)),
			(V = c(S));
		...
		at(() => {
			t.resizeObserver &&
				(!c(z) || c(W) !== X) &&
				(X && t.resizeObserver.unobserve(X), c(W) && t.resizeObserver.observe(c(W)), (X = c(W)));
		}),
		sr(() => {
			var oe;
	...
	function ue(oe) {
		if (!(ms(oe) || n().disableKeyboardA11y))
			if (us.includes(oe.key) && c(E)) {
				...
				n().handleNodeSelection(N, he, c(W));
			} else
				c(v) &&
					t.node.selected &&
					Object.hasOwn(rr, oe.key) &&
					(oe.preventDefault(),
					n(
					...
					n().moveSelectedNodes(rr[oe.key], oe.shiftKey ? 4 : 1));
	}
	const pe = () => {
		var ke;
		if (
			...
			!((ke = c(W)) != null && ke.matches(':focus-visible'))
		)
			return;
		const { width: oe, height: he, viewport: _e } = n();
		mo(new Map([[N, t.node]]), { x: 0, y: 0, width: oe, height: he }, [_e.x, _e.y, _e.zoom], !0)
			.length > 0 ||
			n().setCenter(
...
function xh(e, t) {
	...
	const n = b(() => t.edge.id),
		...
		R = b(() => t.edge.markerStart),
		L = b(() => t.edge.markerEnd),
		F = b(() => t.edge.selectable),
		U = b(() => t.edge.focusable),
	...
	let v = null,
		...
		y = b(() => c(U) ?? t.store.edgesFocusable),
		k = b(() => t.store.edgeTypes[c(O)] ?? Ts),
		I = b(() => (c(R) ? `url('#${jr(c(R), t.store.flowId)}')` : void 0)),
		z = b(() => (c(L) ? `url('#${jr(c(L), t.store.flowId)}')` : void 0));
	function T(D) {
		var Q;
		const V = t.store.edgeLookup.get(c(n));
		V &&
			(c(E) && t.store.handleEdgeSelection(c(n)),
			(Q = t.onedgeclick) == null || Q.call(t, { event: D, edge: V }));
	}
	function K(D, V) {
	...
	function q(D) {
		if (!t.store.disableKeyboardA11y && us.includes(D.key) && c(E)) {
			const { unselectNodesAndEdges: V, addSelectedEdges: Q } = t.store;
			D.key === 'Escape' ? (v == null || v.blur(), V({ edges: [t.edge] })) : Q([c(n)]);
		}
	}
	var W = Re(),
		X = me(W);
	var j = (D) => {
		...
		yt(ie, () => ({
			...
			onkeydown: c(y) ? q : void 0,
			tabindex: c(y) ? 0 : void 0,
			...t.edge.domAttributes,
			[no]: { animated: c(h), selected: c(f), selectable: c(E) },
		}));
		var ge = ee(ie);
		io(
			ge,
...
function Eh(e, t) {
	le(t, !0);
	const n = G(t, 'width', 3, 12.5),
		r = G(t, 'height', 3, 12.5),
		o = G(t, 'markerUnits', 3, 'strokeWidth'),
		s = G(t, 'orient', 3, 'auto-start-reverse'),
		i = G(t, 'color', 3, 'none');
	var a = Sh(),
		l = ee(a);
	var d = (h) => {
	...
	ve(l, (h) => {
		t.type === er.Arrow ? h(d) : t.type === er.ArrowClosed && h(u, 1);
	});
	J(a),
		ye(() => {
			be(a, 'id', t.id),
...
function Ah(e, t) {
	...
	const r = b(() => {
		if (t.store.selectionRectMode === 'nodes') {
			t.store.nodes;
			const h = hr(t.store.nodeLookup, { filter: (f) => !!f.selected });
	...
	function i(h) {
		Object.hasOwn(rr, h.key) &&
			(h.preventDefault(), t.store.moveSelectedNodes(rr[h.key], h.shiftKey ? 4 : 1));
	}
	var a = Re(),
		l = me(a);
	var d = (h) => {
			...
			Rs(m, { width: '100%', height: '100%', x: 0, y: 0 }),
				...
				ye(
					(x) => {
						vt(f, 1, ro(['svelte-flow__selection-wrapper', t.store.noPanClass]), 'svelte-sf2y5e'),
		...
		for (const h of l) {
			...
			if (S) {
				...
				if (g === null || g === !1) {
					...
					let A = !1;
					for (const R of P)
						if ((Array.isArray(R) ? R : [R]).reduce((F, U) => F | zh(U), 0) === d) {
							A = !0;
							break;
						}
					if (!A) continue;
	...
	return (
		n && (i = Lr(e, o, s)),
		{
			update: (a) => {
				...
				n && (!l || o !== d) ? i == null || i() : !n && l && (i = Lr(e, d, s)),
					(n = l),
					(o = d),
					(r = a.trigger);
			},
...
function Ih(e, t) {
	le(t, !0);
	const n = G(t, 'store', 15),
		r = G(t, 'selectionKey', 3, 'Shift'),
		o = G(t, 'multiSelectionKey', 19, () => (nr() ? 'Meta' : 'Control')),
		s = G(t, 'deleteKey', 3, 'Backspace'),
		i = G(t, 'panActivationKey', 3, ' '),
		a = G(t, 'zoomActivationKey', 19, () => (nr() ? 'Meta' : 'Control')),
		{ deleteElements: l } = Th();
	function d(x) {
...
function Hh(e, t) {
	...
	const n = b(() => {
		...
		switch (t.type) {
			...
			case ft.Step:
			case ft.SmoothStep: {
				const [a] = po({ ...i, borderRadius: t.type === ft.Step ? 0 : void 0 });
				return a;
			}
		}
	});
	...
	var s = (i) => {
		...
		J(l),
			...
			ye(
				...
				[() => ro(['svelte-flow__connection', _d(t.store.connection.isValid)])],
			),
			Z(i, a);
	};
	ve(o, (i) => {
...
function Ls(e, t) {
	le(t, !0);
	const n = G(t, 'position', 3, 'top-right'),
		r = Pt(t, Rh),
		o = b(() => `${n()}`.split('-'));
	var s = Lh();
	...
	var i = ee(s);
	Ye(i, () => t.children ?? Gt), J(s), Z(e, s), ce();
}
var Vh = se(
...
function Kh(e, t) {
	le(t, !0);
	const n = G(t, 'position', 3, 'bottom-right');
	var r = Re(),
		o = me(r);
	var s = (i) => {
		Ls(i, {
...
function Fh(e, t) {
	le(t, !0);
	const n = G(t, 'domNode', 15),
		r = G(t, 'clientWidth', 15),
		o = G(t, 'clientHeight', 15),
		s = b(() => t.rest.class),
		i = b(() =>
			Na(t.rest, [
				'id',
...
function qh(e, t) {
	le(t, !0);
	let n = G(t, 'paneClickDistance', 3, 1),
		r = G(t, 'nodeClickDistance', 3, 1),
		o = G(t, 'panOnScrollMode', 19, () => Lt.Free),
		s = G(t, 'preventScrolling', 3, !0),
		i = G(t, 'zoomOnScroll', 3, !0),
		a = G(t, 'zoomOnDoubleClick', 3, !0),
		l = G(t, 'zoomOnPinch', 3, !0),
		d = G(t, 'panOnScroll', 3, !1),
		u = G(t, 'panOnScrollSpeed', 3, 0.5),
		h = G(t, 'panOnDrag', 3, !0),
		f = G(t, 'selectionOnDrag', 3, !1),
		g = G(t, 'autoPanOnSelection', 3, !0),
		m = G(t, 'connectionLineType', 19, () => ft.Bezier),
		x = G(t, 'nodes', 31, () => Wn([])),
		w = G(t, 'edges', 31, () => Wn([])),
		S = G(t, 'viewport', 15, void 0),
		O = Pt(t, Yh),
		P = rh({
			props: O,
			width: t.width,
	...
	A && A.setStore && A.setStore(P),
		...
		at(() => {
			var L;
			const R = { nodes: P.selectedNodes, edges: P.selectedEdges };
			(L = gt(() => t.onselectionchange)) == null || L(R);
			for (const F of P.selectionChangeHandlers.values()) F(R);
		}),
		sr(() => {
			P.reset();
		}),
...
function cg(e, t) {
	le(t, !0);
	const n = G(t, 'position', 3, 'bottom-left'),
		r = G(t, 'orientation', 3, 'vertical'),
		o = G(t, 'showZoom', 3, !0),
		s = G(t, 'showFitView', 3, !0),
		i = G(t, 'showLock', 3, !0),
		a = Pt(t, sg),
		l = b(Qt);
	const d = b(() => ({
...
function hg(e, t) {
	...
	var m = (w) => {
		var S = dg(),
			O = ee(S, !0);
		J(S), ye(() => Ce(O, t.data.description)), Z(w, S);
	};
	ve(g, (w) => {
...
function mg(e, t) {
	...
	var x = (S) => {
		var O = vg(),
			P = ee(O, !0);
		J(O), ye(() => Ce(P, t.data.description)), Z(S, O);
	};
	ve(m, (S) => {
...
function Ng(e, t) {
	...
	Pa(async () => {
		try {
			const D = await zn(`/workflows/${m}`);
			D && Array.isArray(D.nodes) && D.nodes.length > 0
				? H(
						i,
						D.nodes.map((V) => ({
							...V,
				...
				: H(i, [...o], !0),
				D && Array.isArray(D.edges) && D.edges.length > 0
					? H(
							a,
							D.edges.map((V) => ({
								id: V.id,
								source: V.sourceNodeId,
								target: V.targetNodeId,
					...
					: H(a, [...s], !0),
				D && D.isActive !== void 0 && H(S, D.isActive, !0);
		} catch (D) {
			console.warn('Could not load workflow data, using initial mock state.', D),
				H(i, [...o], !0),
				H(a, [...s], !0);
		} finally {
			H(O, !1);
	...
	function P(D) {
		...
		H(l, ((D.clientX - Q.left) / Q.width) * 100), H(d, ((D.clientY - Q.top) / Q.height) * 100);
	}
	function A(D) {
		const V = D.detail ? D.detail.node : D.node;
		H(u, V, !0), H(h, !0), H(f, null);
	}
	function R() {
		H(h, !1), H(u, null);
	}
	...
	async function U() {
		if (c(u)) {
			H(g, !0), H(f, null);
			try {
				const D = await zn('/engine/test-node', {
					method: 'POST',
					body: JSON.stringify({
						nodeId: c(u).id,
				...
				H(f, JSON.stringify(D, null, 2), !0);
			} catch (D) {
				H(f, JSON.stringify({ error: D.message }, null, 2), !0);
			} finally {
				H(g, !1);
			}
		}
	...
	var j = (D) => {
		...
		var He = (xe) => {
				var Pe = _g(),
					ut = ee(Pe),
					pt = ee(ut, !0);
				J(ut), J(Pe), ye(() => Ce(pt, c(f))), Z(xe, Pe);
			},
			Me = (xe) => {
				var Pe = kg();
				Z(xe, Pe);
	...
	J(W),
		...
		ye(() => {
			vt(
				...
				qe(W, `transform: translateX(${c(h) ? '0%' : '100%'})`);
		}),
		Fe('mousemove', Y, P),
		Fe('click', p, L),
		Fe('click', v, F),
