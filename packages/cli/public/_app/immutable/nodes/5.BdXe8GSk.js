import { a as Z } from '../chunks/ad1oCDNU.js';
import { f as h, a as v } from '../chunks/CBtzEIIA.js';
import { d as W, a as w } from '../chunks/CEyMyz77.js';
import { s as M } from '../chunks/CwolrOM7.js';
import { r as Q, b as T } from '../chunks/D-sGiDVg.js';
import {
	a3 as _,
	W as D,
	a0 as e,
...
import { g as X } from '../chunks/FVa1k_Qt.js';
import { i as C } from '../chunks/y3wZxoFQ.js';
var E = h(
...
function st(z, A) {
	...
	async function G() {
		s(p, !0), s(b, '');
		try {
			await Z('/setup', { method: 'POST', body: JSON.stringify({ platformName: l(u) }) }), s(n, 3);
		} catch (a) {
			s(b, a.message, !0);
		} finally {
			s(p, !1);
	...
	var I = (a) => {
		...
		L = (a) => {
			...
			e(g),
				...
				e(o),
				_(() => {
					(g.disabled = l(p)), M(Y, l(p) ? 'Configuring...' : 'Complete Setup');
				}),
				T(
					f,
					() => l(u),
		...
		O = (a) => {
			...
			e(d), J(), e(r);
			var x = i(r, 2);
			e(o), _(() => M(f, l(u))), w('click', x, () => X('/dashboard')), v(a, o);
		};
	C(H, (a) => {
		l(n) === 1 ? a(I) : l(n) === 2 ? a(L, 1) : l(n) === 3 && a(O, 2);
	});
	e(j), e(S), e(y), v(z, y), F();
}
W(['click']);
