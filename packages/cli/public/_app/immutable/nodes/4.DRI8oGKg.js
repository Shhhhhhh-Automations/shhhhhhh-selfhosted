...
import { i as C } from '../chunks/BZ5PAaN8.js';
import { f as h, a as v } from '../chunks/CF3HcCU-.js';
import { s as M } from '../chunks/CTHplljA.js';
import {
	P as _,
	G as D,
	N as e,
...
import { r as Q, b as T } from '../chunks/DVYdd_6U.js';
import { a as w, d as Y } from '../chunks/fY0BZPQl.js';
import { g as E } from '../chunks/gPEcExgJ.js';
...
function st(z, G) {
	...
	C(I, (a) => {
		l(n) === 1 ? a(L) : l(n) === 2 ? a(O, 1) : l(n) === 3 && a(P, 2);
	});
	e(S), e(N), e(y), v(z, y), F();
}
Y(['click']);
