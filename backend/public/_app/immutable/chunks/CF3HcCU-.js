...
function I(e, a) {
	...
	return () => {
		...
		s === void 0 && ((s = E(_ ? e : '<!>' + e)), r || (s = o(s)));
		var t = f || A ? document.importNode(s, !0) : s.cloneNode(!0);
		if (r) {
			var c = o(t),
				u = t.lastChild;
			n(c, u);
...
function B(e, a) {
	if (l) {
		var r = g;
		(!(r.f & M) || r.nodes.end === null) && (r.nodes.end = i), x();
		return;
	}
	e !== null && e.before(a);
}
...
export { $ as c, B as a, H as d, I as f, n as b, S as t };
