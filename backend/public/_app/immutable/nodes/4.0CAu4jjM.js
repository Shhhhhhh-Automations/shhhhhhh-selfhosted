import { i as C } from '../chunks/89-NG9tb.js';
import { a as R } from '../chunks/ad1oCDNU.js';
import { r as Q, b as T } from '../chunks/BNYHR-rk.js';
import { a as w, d as Y } from '../chunks/DA0K5guU.js';
import { s as M } from '../chunks/DiFkmEDl.js';
import { g as E } from '../chunks/fO25O9W7.js';
import {
	N as _,
	L as e,
	H as i,
...
import { f as h, a as v } from '../chunks/pYZ6ss2q.js';
...
function st(z, G) {
	...
	async function H() {
		s(p, !0), s(b, '');
		try {
			await R('/setup', { method: 'POST', body: JSON.stringify({ platformName: l(u) }) }), s(n, 3);
		} catch (a) {
			s(b, a.message, !0);
		} finally {
			s(p, !1);
	...
	var L = (a) => {
		...
		A = (a) => {
			...
			e(g),
				...
				e(o),
				_(() => {
					(g.disabled = l(p)), M(J, l(p) ? 'Configuring...' : 'Complete Setup');
				}),
				T(
					f,
					() => l(u),
		...
		D = (a) => {
			...
			e(d), K(), e(r);
			var x = i(r, 2);
			e(o), _(() => M(f, l(u))), w('click', x, () => E('/dashboard')), v(a, o);
		};
	C(I, (a) => {
		l(n) === 1 ? a(L) : l(n) === 2 ? a(A, 1) : l(n) === 3 && a(D, 2);
	});
	e(S), e(N), e(y), v(z, y), q();
}
Y(['click']);
