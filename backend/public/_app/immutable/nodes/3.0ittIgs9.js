...
var Ee = (e, t, n) => Zs(e, typeof t != 'symbol' ? t + '' : t, n),
	wr = (e, t, n) => t.has(e) || Po('Cannot ' + n);
var C = (e, t, n) => (wr(e, t, 'read from private field'), n ? n.call(e) : t.get(e)),
	B = (e, t, n) =>
		t.has(e)
			...
			: t instanceof WeakSet
				? t.add(e)
				: t.set(e, n),
	sn = (e, t, n, r) => (wr(e, t, 'write to private field'), r ? r.call(e, n) : t.set(e, n), n),
	Ao = (e, t, n) => (wr(e, t, 'access private method'), n);

import { a as kr } from '../chunks/ad1oCDNU.js';
import { s as At, r as Ct, b as En, c as oo, p as U } from '../chunks/Bn3y9Etn.js';
import { i as ve } from '../chunks/BZ5PAaN8.js';
import { s as Ye } from '../chunks/C41dpvGy.js';
import { d as _e, a as G, t as qs, c as Re, f as se, b as xr } from '../chunks/CF3HcCU-.js';
import { w as Ho } from '../chunks/CJfWclPr.js';
import { a as Aa, s as Ce } from '../chunks/CTHplljA.js';
import {
	T as _a,
	b9 as _r,
	K as $,
...
import {
	...
	C as to,
	r as za,
} from '../chunks/DVYdd_6U.js';
import { a as Fe, e as gn, o as Rr, d as ro } from '../chunks/fY0BZPQl.js';
import { a as ir } from '../chunks/LM21Vpnx.js';

const Ia = [];
function Di(e, t = !1, n = !1) {
	return Ln(e, new Map(), '', Ia, null, n);
}
function Ln(e, t, n, r, o = null, s = !1) {
	if (typeof e == 'object' && e !== null) {
		...
		if (Si(e)) {
			...
			for (var l = 0; l < e.length; l += 1) {
				var d = e[l];
				l in e && (a[l] = Ln(d, t, n, r, null, s));
			}
			return a;
		}
		if (Gs(e) === Us) {
			(a = {}), t.set(e, a), o !== null && t.set(o, a);
			for (var u of Object.keys(e)) a[u] = Ln(e[u], t, n, r, null, s);
			return a;
		}
		if (e instanceof Date) return structuredClone(e);
		if (typeof e.toJSON == 'function' && !s) return Ln(e.toJSON(), t, n, r, e);
	}
...
function io(e, t, n, r, o, s = null) {
	...
	if (l) {
		var d = e;
		i = Qe ? hn(Pt(d)) : d.appendChild(pr());
	}
	Qe && Dr();
	var u = null,
		h = ra(() => {
			var P = n();
			return Si(P) ? P : P == null ? [] : $r(P);
		}),
		f,
		g = new Map(),
		m = !0;
	...
	var E = Qs(() => {
			...
			if (Qe) {
				var H = Js(i) === js;
				H !== (P === 0) && ((i = zo()), hn(i), br(!1), (A = !0));
			}
			for (var L = new Set(), F = ea, W = na(), Y = 0; Y < P; Y += 1) {
				Qe && zt.nodeType === Ei && zt.data === $s && ((i = zt), (A = !0), br(!1));
				var Q = f[Y],
					M = r(Q, Y),
					p = m ? null : a.get(M);
				p
					? (p.v && To(p.v, Q), p.i && To(p.i, Y), W && F.unskip_effect(p.e))
					: ((p = Ha(a, m ? i : (Ro ?? (Ro = pr())), Q, M, Y, o, t, n)),
						m || (p.e.f |= $e),
						a.set(M, p)),
					L.add(M);
			}
			if (
				(P === 0 &&
					s &&
					!u &&
					(m ? (u = Hr(() => s(i))) : ((u = Hr(() => s(Ro ?? (Ro = pr())))), (u.f |= $e))),
				P > L.size && ta(),
				Qe && P > 0 && hn(zo()),
				!m)
			)
				if ((g.set(F, L), W)) {
					for (const [N, v] of a) L.has(N) || F.skip_effect(v.e);
					F.oncommit(x), F.ondiscard(w);
				} else x(F);
			A && br(!0), c(h);
		}),
		O = { effect: E, items: a, pending: g, outrogroups: null, fallback: u };
	(m = !1), Qe && (i = zt);
}
function an(e) {
	for (; e !== null && !(e.f & ua); ) e = e.next;
	return e;
}
function Da(e, t, n, r, o) {
	var Q, M, p, N, v, S, y, k, I;
	var s = (r & da) !== 0,
		i = t.length,
		a = e.items,
		l = an(e.effect.first),
	...
	if (s)
		for (E = 0; E < i; E += 1)
			(m = t[E]),
				...
				(w = a.get(x).e),
				w.f & $e ||
					((M = (Q = w.nodes) == null ? void 0 : Q.a) == null || M.measure(),
					(h ?? (h = new Set())).add(w));
	for (E = 0; E < i; E += 1) {
		if (((m = t[E]), (x = o(m, E)), (w = a.get(x).e), e.outrogroups !== null))
			...
			if (d !== void 0 && d.has(w)) {
				if (f.length < g.length) {
					...
					d.delete(w),
						un(w, l, n),
						ct(e, w.prev, w.next),
						ct(e, w, u === null ? e.effect.first : u.next),
						ct(e, u, w),
						(u = w);
				continue;
			}
		...
		w.f & $e || f.push(w), (u = w), (l = an(w.next));
	}
	...
	if (l !== null || d !== void 0) {
		var F = [];
		if (d !== void 0) for (w of d) w.f & _r || F.push(w);
		for (; l !== null; ) !(l.f & _r) && l !== e.fallback && F.push(l), (l = an(l.next));
		var W = F.length;
		if (W > 0) {
			var Y = r & Ci && i === 0 ? n : null;
			if (s) {
				for (E = 0; E < W; E += 1)
					(y = (S = F[E].nodes) == null ? void 0 : S.a) == null || y.measure();
				for (E = 0; E < W; E += 1) (I = (k = F[E].nodes) == null ? void 0 : k.a) == null || I.fix();
			}
			Oa(e, F, Y);
		}
	}
...
function Ha(e, t, n, r, o, s, i, a) {
	var l = i & ia ? (i & sa ? Io(n) : aa(n, !1, !1)) : null,
		d = i & oa ? Io(o) : null;
	return {
		v: l,
		i: d,
...
function un(e, t, n) {
	if (e.nodes)
		for (
			var r = e.nodes.start, o = e.nodes.end, s = t && !(t.f & $e) ? t.nodes.start : n;
			r !== null;
		) {
			var i = Pi(r);
...
function so(e, t, n = !1, r = !1, o = !1, s = !1) {
	...
	ye(() => {
		...
		if (n && !Qe) {
			(d.nodes = null), (l.innerHTML = a), a !== '' && xr(Pt(l), l.lastChild);
			return;
		}
		if ((d.nodes !== null && (ya(d.nodes.start, d.nodes.end), (d.nodes = null)), a !== '')) {
			if (Qe) {
				zt.data;
				for (var u = Dr(), h = u; u !== null && (u.nodeType !== Ei || u.data !== ''); )
					(h = u), (u = Pi(u));
				if (u === null) throw (ma(), wa);
				xr(zt, h), (i = hn(u));
				return;
			}
			var f = r ? pa : o ? ba : void 0,
				g = xa(r ? 'svg' : o ? 'math' : 'template', f);
			g.innerHTML = a;
			var m = r || o ? g : g.content;
			if ((xr(Pt(m), m.lastChild), r || o)) for (; Pt(m); ) i.before(Pt(m));
			else i.before(m);
		}
	});
}
...
const rr = class rr {
	constructor(t) {
		B(this, nr);
		B(this, dt, new WeakMap());
		B(this, Rt);
		B(this, bn);
		sn(this, bn, t);
	}
	observe(t, n) {
		var r = C(this, dt).get(t) || new Set();
		return (
			r.add(n),
			C(this, dt).set(t, r),
			Ao(this, nr, Hi).call(this).observe(t, C(this, bn)),
			() => {
				var o = C(this, dt).get(t);
				o.delete(n), o.size === 0 && (C(this, dt).delete(t), C(this, Rt).unobserve(t));
			}
		);
	}
};
		...
		return (
			...
			sn(
				...
				new ResizeObserver((t) => {
					for (var n of t) {
						rr.entries.set(n.target, n);
						for (var r of C(this, dt).get(n.target) || []) r(n);
					}
				}),
			)
		);
	}),
	Ee(rr, 'entries', new WeakMap());
const Vr = rr;
...
Vn.prototype = sr.prototype = {
	...
	on: function (e, t) {
		...
		for (; ++s < i; )
			if ((o = (e = r[s]).type)) n[o] = Ko(n[o], e.name, t);
			else if (t == null) for (o in n) n[o] = Ko(n[o], e.name, null);
		return this;
	},
	copy: function () {
		var e = {},
...
function ar(e) {
	...
	return (
		...
		Object.hasOwn(Bo, t) ? { space: Bo[t], local: e } : e
	);
}
function Fa(e) {
	return function () {
...
function Ua(e) {
	typeof e == 'function' ? (e = Ga(e)) : (e = Li(e));
...
function $a(e) {
	return this.select(e == null ? ja : Ja(typeof e == 'function' ? e : Ki(e)));
}
...
function rl(e) {
	return this.selectAll(e == null ? tl : nl(typeof e == 'function' ? e : Ki(e)));
}
function ol(e) {
...
function il() {
	return new Le(this._enter || this._groups.map(Bi), this._parents);
}
function Xn(e, t) {
...
function al(e, t, n, r, o, s) {
	for (var i = 0, a, l = t.length, d = s.length; i < d; ++i)
		(a = t[i]) ? ((a.__data__ = s[i]), (r[i] = a)) : (n[i] = new Xn(e, s[i]));
...
function ll(e, t, n, r, o, s, i) {
	...
	for (a = 0; a < h; ++a)
		(g = i.call(e, s[a], a, s) + ''),
			(l = d.get(g)) ? ((r[a] = l), (l.__data__ = s[a]), d.delete(g)) : (n[a] = new Xn(e, s[a]));
...
function fl() {
	return new Le(this._exit || this._groups.map(Bi), this._parents);
}
function hl(e, t, n) {
	var r = this.enter(),
		o = this,
...
function Bl(e, t) {
	return function () {
		(t.apply(this, arguments) ? Wi : Zi)(this, e);
	};
}
function Fl(e, t) {
	var n = Yi(e + '');
...
function Cn() {
	return new Le([[document.documentElement]], Gi);
}
function xc() {
	return this;
}
...
function Ui(e) {
	var t = e.document.documentElement,
		n = Xe(e).on('dragstart.drag', It, yn);
	'onselectstart' in t
		? n.on('selectstart.drag', It, yn)
...
function Cc() {
	...
	function g(A, H) {
		if (!(u || !e.call(this, A, H))) {
			var L = P(this, t.call(this, A, H), A, H, 'mouse');
			L &&
	...
	function x(A) {
		Xe(A.view).on('mousemove.drag mouseup.drag', null), Qi(A.view, d), It(A), o.mouse('end', A);
	}
	function w(A, H) {
		if (e.call(this, A, H)) {
			var L = A.changedTouches,
				...
				Q;
			for (Y = 0; Y < W; ++Y)
				(Q = P(this, F, A, H, L[Y].identifier, L[Y])) && (Sr(A), Q('start', A, L[Y]));
		}
	}
	function E(A) {
		var H = A.changedTouches,
			...
			F,
			W;
		for (F = 0; F < L; ++F) (W = o[H[F].identifier]) && (It(A), W('drag', A, H[F]));
	}
	function O(A) {
		var H = A.changedTouches,
			L = H.length,
		...
		for (
			...
			(W = o[H[F].identifier]) && (Sr(A), W('end', A, H[F]));
	}
	function P(A, H, L, F, W, Y) {
		var Q = s.copy(),
			M = Ue(Y || L, H),
			p,
			N,
	...
	return (
		(f.filter = function (A) {
			return arguments.length ? ((e = typeof A == 'function' ? A : zn(!!A)), f) : e;
		}),
		(f.container = function (A) {
			return arguments.length ? ((t = typeof A == 'function' ? A : zn(A)), f) : t;
		}),
		(f.subject = function (A) {
			return arguments.length ? ((n = typeof A == 'function' ? A : zn(A)), f) : n;
		}),
		(f.touchable = function (A) {
			return arguments.length ? ((r = typeof A == 'function' ? A : zn(!!A)), f) : r;
		}),
		(f.on = function () {
...
var mn = 0.7,
	...
	et = '\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*',
	Mc = /^#([0-9a-f]{3,8})$/,
	Nc = new RegExp(`^rgb\\(${Ot},${Ot},${Ot}\\)$`),
	Pc = new RegExp(`^rgb\\(${et},${et},${et}\\)$`),
	Ac = new RegExp(`^rgba\\(${Ot},${Ot},${Ot},${wn}\\)$`),
	zc = new RegExp(`^rgba\\(${et},${et},${et},${wn}\\)$`),
	Tc = new RegExp(`^hsl\\(${wn},${et},${et}\\)$`),
	Ic = new RegExp(`^hsla\\(${wn},${et},${et},${wn}\\)$`),
	Fo = {
		aliceblue: 15792383,
			...
			? ((n = t[1].length),
				...
				n === 6
					...
					: n === 3
						...
						: n === 8
							? Tn((t >> 24) & 255, (t >> 16) & 255, (t >> 8) & 255, (t & 255) / 255)
							: n === 4
								? Tn(
										((t >> 12) & 15) | ((t >> 8) & 240),
										((t >> 8) & 15) | ((t >> 4) & 240),
								...
								: null)
			: (t = Nc.exec(e))
				? new He(t[1], t[2], t[3], 1)
				: (t = Pc.exec(e))
					? new He((t[1] * 255) / 100, (t[2] * 255) / 100, (t[3] * 255) / 100, 1)
					: (t = Ac.exec(e))
						? Tn(t[1], t[2], t[3], t[4])
						: (t = zc.exec(e))
							? Tn((t[1] * 255) / 100, (t[2] * 255) / 100, (t[3] * 255) / 100, t[4])
							: (t = Tc.exec(e))
...
function Hc(e) {
	return (
		e instanceof Mn || (e = pt(e)), e ? ((e = e.rgb()), new He(e.r, e.g, e.b, e.opacity)) : new He()
	);
}
function Fr(e, t, n, r) {
	return arguments.length === 1 ? Hc(e) : new He(e, t, n, r ?? 1);
}
function He(e, t, n, r) {
...
co(
	...
	Ji(Mn, {
		brighter(e) {
			return (
				(e = e == null ? Wn : Wn ** e), new He(this.r * e, this.g * e, this.b * e, this.opacity)
			);
		},
		darker(e) {
			return (
				(e = e == null ? mn : mn ** e), new He(this.r * e, this.g * e, this.b * e, this.opacity)
			);
		},
		rgb() {
			return this;
		...
		clamp() {
			return new He(xt(this.r), xt(this.g), xt(this.b), Zn(this.opacity));
		},
		displayable() {
			return (
				-0.5 <= this.r &&
...
function ji(e) {
	...
	if ((e instanceof Mn || (e = pt(e)), !e)) return new We();
...
co(
	...
	Ji(Mn, {
		brighter(e) {
			return (e = e == null ? Wn : Wn ** e), new We(this.h, this.s, this.l * e, this.opacity);
		},
		darker(e) {
		...
		clamp() {
			return new We(Uo(this.h), In(this.s), In(this.l), Zn(this.opacity));
		},
		displayable() {
			return (
...
function Bc(e) {
	return (e = +e) == 1 ? $i : (t, n) => (n - t ? Kc(t, n, e) : uo(isNaN(t) ? n : t));
}
function $i(e, t) {
	var n = t - e;
...
function Uc(e) {
	...
	return t.isIdentity ? Xr : ts(t.a, t.b, t.c, t.d, t.e, t.f);
}
function Qc(e) {
	return e == null ||
		(On || (On = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
		On.setAttribute('transform', e),
		!(e = On.transform.baseVal.consolidate()))
		? Xr
		: ((e = e.matrix), ts(e.a, e.b, e.c, e.d, e.e, e.f));
}
function ns(e, t, n, r) {
	function o(d) {
...
const Kn = (function e(t, n, r) {
	function o(s, i) {
		var a = s[0],
			...
			E;
		if (x < $c)
			(E = Math.log(f / d) / t), (w = (F) => [a + F * g, l + F * m, d * Math.exp(t * F * E)]);
		else {
			var O = Math.sqrt(x),
				P = (f * f - d * d + r * x) / (2 * d * n * O),
				A = (f * f - d * d - r * x) / (2 * f * n * O),
				H = Math.log(Math.sqrt(P * P + 1) - P),
				L = Math.log(Math.sqrt(A * A + 1) - A);
			(E = (L - H) / t),
				(w = (F) => {
					var W = F * E,
						Y = Jo(H),
						Q = (d / (n * O)) * (Y * tu(t * W + H) - eu(H));
					return [a + Q * g, l + Q * m, (d * Y) / Jo(t * W + H)];
				});
		}
		return (w.duration = (E * 1e3 * t) / Math.SQRT2), w;
	}
	return (
		(o.rho = (s) => {
...
Qn.prototype = is.prototype = {
	...
	restart: function (e, t, n) {
		...
		(n = (n == null ? fo() : +n) + (t == null ? 0 : +t)),
			!this._next && fn !== this && (fn ? (fn._next = this) : (Gn = this), (fn = this)),
			(this._call = e),
			(this._time = n),
			Wr();
	},
...
function ru() {
	fo(), ++Vt;
	for (var e = Gn, t; e; ) (t = bt - e._time) >= 0 && e._call.call(void 0, t), (e = e._next);
	--Vt;
}
function jo() {
	(bt = (Un = xn.now()) + lr), (Vt = dn = 0);
	try {
		ru();
	} finally {
		(Vt = 0), iu(), (bt = 0);
...
function iu() {
	for (var e, t = Gn, n, r = 1 / 0; t; )
		t._call
			? (r > t._time && (r = t._time), (e = t), (t = t._next))
			: ((n = t._next), (t._next = null), (t = e ? (e._next = n) : (Gn = n)));
	(fn = e), Wr(r);
}
function Wr(e) {
	if (!Vt) {
		...
		var t = e - bt;
		t > 24
			? (e < 1 / 0 && (dn = setTimeout(jo, e - xn.now() - lr)), ln && (ln = clearInterval(ln)))
			: (ln || ((Un = xn.now()), (ln = setInterval(ou, rs))), (Vt = 1), os(jo));
	}
}
function $o(e, t, n) {
	var r = new Qn();
...
var su = sr('start', 'end', 'cancel', 'interrupt'),
	au = [],
	ss = 0,
	ei = 1,
	Zr = 2,
...
function lu(e, t, n) {
	var r = e.__transition,
		o;
	(r[t] = n), (n.timer = is(s, 0, n.time));
	function s(d) {
		(n.state = ei), n.timer.restart(i, n.delay, n.time), n.delay <= d && i(d - n.delay);
	}
	function i(d) {
		var u, h, f, g;
		if (n.state !== ei) return l();
		for (u in r)
			if (((g = r[u]), g.name === n.name)) {
				if (g.state === Bn) return $o(i);
				g.state === ti
					? ((g.state = Fn),
						g.timer.stop(),
		...
		if (
			($o(() => {
				n.state === Bn && ((n.state = ti), n.timer.restart(a, n.delay, n.time), a(d));
			}),
			(n.state = Zr),
			n.on.call('start', e, e.__data__, n.index, n.group),
			n.state === Zr)
		) {
			for (n.state = Bn, o = new Array((f = n.tween.length)), u = 0, h = -1; u < f; ++u)
	...
	function l() {
		(n.state = Fn), n.timer.stop(), delete r[t];
...
function as(e, t) {
	var n;
	return (typeof t == 'number' ? Je : t instanceof pt ? qn : (n = pt(t)) ? ((t = n), qn) : es)(
		e,
		t,
	);
}
	...
	for (var r = this._groups, o = r.length, s = new Array(o), i = 0; i < o; ++i)
		for (var a = r[i], l = a.length, d = (s[i] = new Array(l)), u, h, f = 0; f < l; ++f)
			(u = a[f]) &&
				...
				('__data__' in u && (h.__data__ = u.__data__), (d[f] = h), cr(d[f], t, n, f, d, Ge(u, n)));
	return new at(s, this._parents, t, n);
}
function Yu(e) {
	var t = this._name,
		n = this._id;
		...
		for (var l = r[a], d = l.length, u, h = 0; h < d; ++h)
			if ((u = l[h])) {
				for (var f = e.call(u, u.__data__, h, l), g, m = Ge(u, n), x = 0, w = f.length; x < w; ++x)
					(g = f[x]) && cr(g, t, n, x, f, m);
				s.push(f), i.push(u);
			}
	return new at(s, i, t, n);
}
...
function Zu(e, t) {
	...
	return function () {
		var s = Lt(this, e),
			i = (this.style.removeProperty(e), Lt(this, e));
...
function Gu(e, t, n) {
	...
	return function () {
		var i = Lt(this, e),
			...
			l = a + '';
		return (
			a == null && (l = a = (this.style.removeProperty(e), Lt(this, e))),
			i === l ? null : i === r && l === o ? s : ((o = l), (s = t((r = i), a)))
		);
	};
}
function Uu(e, t) {
	...
	return function () {
		var l = nt(this, e),
			d = l.on,
			u = l.value[s] == null ? a || (a = ls(t)) : void 0;
		(d !== n || o !== u) && (r = (n = d).copy()).on(i, (o = u)), (l.on = r);
	};
}
function Qu(e, t, n) {
	var r = (e += '') == 'transform' ? Jc : as;
	return t == null
		? this.styleTween(e, Zu(e, r)).on('end.style.' + e, ls(e))
		: typeof t == 'function'
...
function sd() {
	for (
		var e = this._name, t = this._id, n = cs(), r = this._groups, o = r.length, s = 0;
		s < o;
		++s
	)
...
function fd(e) {
	...
	e instanceof at
		? ((t = e._id), (e = e._name))
		: ((t = cs()), ((n = ud).time = fo()), (e = e == null ? null : e + ''));
	for (var r = this._groups, o = r.length, s = 0; s < o; ++s)
		for (var i = r[s], a = i.length, l, d = 0; d < a; ++d)
			(l = i[d]) && cr(l, e, t, d, i, n || dd(l, t));
...
function xd() {
			...
			E.transform(
				...
				function () {
					var I = t.apply(this, arguments),
						...
						K = z.invert(T),
						Z = typeof S == 'function' ? S.apply(this, arguments) : S;
					return n(P(O(z, Z), T, K), I, i);
				},
				y,
				k,
			);
		}),
		(E.translateBy = (v, S, y, k) => {
			E.transform(
				v,
				function () {
					return n(
	...
	function O(v, S) {
		return (S = Math.max(s[0], Math.min(s[1], S))), S === v.k ? v : new ot(S, v.x, v.y);
	}
	function P(v, S, y) {
		var k = S[0] - y[0] * v.k,
			I = S[1] - y[1] * v.k;
		return k === v.x && I === v.y ? v : new ot(v.k, k, I);
	}
	function A(v) {
		...
		v.on('start.zoom', function () {
			...
			.tween('zoom', function () {
				var z = arguments,
					T = L(this, z).event(k),
					K = t.apply(this, z),
					Z = y == null ? A(K) : typeof y == 'function' ? y.apply(this, z) : y,
					D = Math.max(K[1][0] - K[0][0], K[1][1] - K[0][1]),
					V = this.__zoom,
					X = typeof S == 'function' ? S.apply(this, z) : S,
					J = l(V.invert(Z).concat(D / V.k), X.invert(Z).concat(D / X.k));
				return (q) => {
					if (q === 1) q = X;
					else {
						var ee = J(q),
							oe = D / ee[2];
						q = new ot(oe, Z[0] - ee[0] * oe, Z[1] - ee[1] * oe);
					}
					T.zoom(null, q);
				};
			});
	...
	function L(v, S, y) {
		return (!y && v.__zooming) || new F(v, S);
	}
	function F(v, S) {
		(this.that = v),
			(this.args = S),
	...
	F.prototype = {
		...
		zoom: function (v, S) {
			return (
				this.mouse && v !== 'mouse' && (this.mouse[1] = S.invert(this.mouse[0])),
				this.touch0 && v !== 'touch' && (this.touch0[1] = S.invert(this.touch0[0])),
				this.touch1 && v !== 'touch' && (this.touch1[1] = S.invert(this.touch1[0])),
				(this.that.__zoom = S),
				this.emit('zoom'),
				this
			);
	...
	function W(v, ...S) {
		...
		if (y.wheel)
			...
			if (k.k === I) return;
			(y.mouse = [z, k.invert(z)]), Yn(this), y.start();
		}
		cn(v),
	...
	function Y(v, ...S) {
		...
		var y = v.currentTarget,
			k = L(this, S, !0).event(v),
			I = Xe(v.view).on('mousemove.zoom', Z, !0).on('mouseup.zoom', D, !0),
			z = Ue(v, y),
			T = v.clientX,
			K = v.clientY;
		Ui(v.view), Mr(v), (k.mouse = [z, this.__zoom.invert(z)]), Yn(this), k.start();
		function Z(V) {
			if ((cn(V), !k.moved)) {
				var X = V.clientX - T,
					J = V.clientY - K;
			...
			k.event(V).zoom(
				'mouse',
				n(P(k.that.__zoom, (k.mouse[0] = Ue(V, y)), k.mouse[1]), k.extent, i),
			);
		}
		function D(V) {
			I.on('mousemove.zoom mouseup.zoom', null), Qi(V.view, k.moved), cn(V), k.event(V).end();
		}
	}
	function Q(v, ...S) {
		if (e.apply(this, arguments)) {
			var y = this.__zoom,
				k = Ue(v.changedTouches ? v.changedTouches[0] : v, this),
				I = y.invert(k),
				z = y.k * (v.shiftKey ? 0.5 : 2),
				T = n(P(O(y, z), k, I), t.apply(this, S), i);
			cn(v),
				a > 0
					? Xe(this).transition().duration(a).call(H, T, k, v)
					: Xe(this).call(E.transform, T, k, v);
		}
	}
	function M(v, ...S) {
		if (e.apply(this, arguments)) {
			var y = v.touches,
				k = y.length,
				I = L(this, S, v.changedTouches.length === k).event(v),
				z,
				T,
				K,
				Z;
			for (Mr(v), T = 0; T < k; ++T)
				(K = y[T]),
					(Z = Ue(K, this)),
					(Z = [Z, this.__zoom.invert(Z), K.identifier]),
					I.touch0
						? !I.touch1 && I.touch0[2] !== Z[2] && ((I.touch1 = Z), (I.taps = 0))
						: ((I.touch0 = Z), (z = !0), (I.taps = 1 + !!u));
			u && (u = clearTimeout(u)),
				z &&
					(I.taps < 2 &&
						((h = Z[0]),
		...
		if (this.__zooming) {
			...
			if (((T = y.that.__zoom), y.touch1)) {
				var D = y.touch0[0],
					...
					X = y.touch1[0],
					J = y.touch1[1],
					q = (q = X[0] - D[0]) * q + (q = X[1] - D[1]) * q,
					ee = (ee = J[0] - V[0]) * ee + (ee = J[1] - V[1]) * ee;
				(T = O(T, Math.sqrt(q / ee))),
					(K = [(D[0] + X[0]) / 2, (D[1] + X[1]) / 2]),
					(Z = [(V[0] + J[0]) / 2, (V[1] + J[1]) / 2]);
			} else if (y.touch0) (K = y.touch0[0]), (Z = y.touch0[1]);
			else return;
			y.zoom('touch', n(P(T, K, Z), y.extent, i));
		}
	}
	function N(v, ...S) {
		if (this.__zooming) {
			...
			if ((y.touch1 && !y.touch0 && ((y.touch0 = y.touch1), delete y.touch1), y.touch0))
				...
				(y.end(), y.taps === 2 && ((T = Ue(T, this)), Math.hypot(h[0] - T[0], h[1] - T[1]) < w))
			) {
	...
	return (
		(E.wheelDelta = function (v) {
			return arguments.length ? ((r = typeof v == 'function' ? v : Dn(+v)), E) : r;
		}),
		(E.filter = function (v) {
			return arguments.length ? ((e = typeof v == 'function' ? v : Dn(!!v)), E) : e;
		}),
		(E.touchable = function (v) {
			return arguments.length ? ((o = typeof v == 'function' ? v : Dn(!!v)), E) : o;
		}),
		(E.extent = function (v) {
			return arguments.length
				? ((t =
		...
		(E.scaleExtent = function (v) {
			return arguments.length ? ((s[0] = +v[0]), (s[1] = +v[1]), E) : [s[0], s[1]];
		}),
		(E.translateExtent = function (v) {
			return arguments.length
				? ((i[0][0] = +v[0][0]),
					(i[1][0] = +v[1][0]),
					(i[0][1] = +v[0][1]),
		...
		(E.constrain = function (v) {
			return arguments.length ? ((n = v), E) : n;
		}),
		(E.duration = function (v) {
			return arguments.length ? ((a = +v), E) : a;
		}),
		(E.interpolate = function (v) {
			return arguments.length ? ((l = v), E) : l;
		}),
		(E.on = function () {
			var v = d.on.apply(d, arguments);
			return v === d ? E : v;
		}),
		(E.clickDistance = function (v) {
			return arguments.length ? ((x = (v = +v) * v), E) : Math.sqrt(x);
		}),
		(E.tapDistance = function (v) {
			return arguments.length ? ((w = +v), E) : w;
		}),
		E
	);
}
...
const ri = { [ne.Left]: ne.Right, [ne.Right]: ne.Left, [ne.Top]: ne.Bottom, [ne.Bottom]: ne.Top };
function bd(e, t) {
	if (!e && !t) return !0;
...
const fs = (e) => 'id' in e && 'source' in e && 'target' in e,
	...
	Sd = (e, t = { nodeOrigin: [0, 0] }) => {
		...
		const n = e.reduce(
			(r, o) => {
				...
				const a = i ? $n(i, t.nodeOrigin) : { x: 0, y: 0, x2: 0, y2: 0 };
				return fr(r, a);
			},
	...
	dr = (e, t = {}) => {
		...
		return (
			e.forEach((o) => {
				(t.filter === void 0 || t.filter(o)) && ((n = fr(n, $n(o))), (r = !0));
			}),
			r ? hr(n) : { x: 0, y: 0, width: 0, height: 0 }
		);
	},
	yo = (e, t, [n, r, o] = [0, 0, 1], s = !1, i = !1) => {
		const a = { ...Zt(t, [n, r, o]), width: t.width / o, height: t.height / o },
			l = [];
		for (const d of e.values()) {
			...
			const g = u.width ?? d.width ?? d.initialWidth ?? null,
				...
				w = (g ?? 0) * (m ?? 0),
				E = s && x > 0;
			(!d.internals.handleBounds || E || x >= w || d.dragging) && l.push(d);
		}
		return l;
	},
	Ed = (e, t) => {
...
function hs({
	...
	const f = Xt(h) ? kt(t, h, i.measured) : t;
	return (
		(i.measured.width === void 0 || i.measured.height === void 0) &&
			(s == null || s('015', _t.error015())),
		{
			position: {
...
const ii = (e, t, n) =>
		e < t ? Bt(Math.abs(e - t), 1, t) / t : e > n ? -Bt(Math.abs(e - n), 1, t) / t : 0,
	mo = (e, t, n = 15, r = 40) => {
		const o = ii(e.x, r, t.width - r) * n,
			s = ii(e.y, r, t.height - r) * n;
		return [o, s];
	},
	fr = (e, t) => ({
		x: Math.min(e.x, t.x),
	...
	hr = ({ x: e, y: t, x2: n, y2: r }) => ({ x: e, y: t, width: n - e, height: r - t }),
	Ft = (e, t = [0, 0]) => {
		var o, s;
	...
	si = (e) => it(e.width) && it(e.height) && it(e.x) && it(e.y),
	it = (e) => !isNaN(e) && isFinite(e),
	vs = (e, t) => (n, r) => {},
	Pn = (e, t = [1, 1]) => ({ x: t[0] * Math.round(e.x / t[0]), y: t[1] * Math.round(e.y / t[1]) }),
	Zt = ({ x: e, y: t }, [n, r, o], s = !1, i = [1, 1]) => {
		const a = { x: (e - n) / o, y: (t - r) / o };
		return s ? Pn(a, i) : a;
	},
	Yt = ({ x: e, y: t }, [n, r, o]) => ({ x: e * o + n, y: t * o + r });
function Nt(e, t) {
...
function Ad(e, t, n) {
	...
	if (typeof e == 'object') {
		const r = Nt(e.top ?? e.y ?? 0, n),
			o = Nt(e.bottom ?? e.y ?? 0, n),
			s = Nt(e.left ?? e.x ?? 0, t),
			i = Nt(e.right ?? e.x ?? 0, t);
		return { top: r, right: i, bottom: o, left: s, x: s + i, y: r + o };
	}
	return { top: 0, right: 0, bottom: 0, left: 0, x: 0, y: 0 };
}
function zd(e, t, n, r, o, s) {
	const { x: i, y: a } = Yt(e, [t, n, r]),
		{ x: l, y: d } = Yt({ x: e.x + e.width, y: e.y + e.height }, [t, n, r]),
		u = o - l,
		h = s - d;
...
const ys = (e) => ({ width: e.offsetWidth, height: e.offsetHeight }),
	ms = (e) => {
		var t;
		return (
...
function li({ pos: e, x1: t, y1: n, x2: r, y2: o, c: s }) {
	switch (e) {
		case ne.Left:
			return [t - Hn(t - r, s), n];
		case ne.Right:
...
function ps({
	...
	const [a, l] = li({ pos: n, x1: e, y1: t, x2: r, y2: o, c: i }),
		[d, u] = li({ pos: s, x1: r, y1: o, x2: e, y2: t, c: i }),
		[h, f, g, m] = Hd({
			sourceX: e,
			sourceY: t,
			targetX: r,
...
const Vd = ({ source: e, sourceHandle: t, target: n, targetHandle: r }) =>
	...
	Bd = (e, t, n = {}) => {
		...
		if (!e.source || !e.target)
			return (s = n.onError) == null || s.call(n, '006', _t.error006()), t;
...
function _s({ sourceX: e, sourceY: t, targetX: n, targetY: r }) {
	const [o, s, i, a] = bs({ sourceX: e, sourceY: t, targetX: n, targetY: r });
	...
	Fd = ({ source: e, sourcePosition: t = ne.Bottom, target: n }) =>
		t === ne.Left || t === ne.Right
			...
			: e.y < n.y
				? { x: 0, y: 1 }
				: { x: 0, y: -1 },
	ui = (e, t) => Math.sqrt((t.x - e.x) ** 2 + (t.y - e.y) ** 2);
function Yd({
	source: e,
	...
	const E = { x: 0, y: 0 },
		O = { x: 0, y: 0 },
		[, , P, A] = bs({ sourceX: e.x, sourceY: e.y, targetX: n.x, targetY: n.y });
	if (a[f] * l[f] === -1) {
		f === 'x'
		...
		a[f] === g ? (m = f === 'x' ? W : Y) : (m = f === 'x' ? Y : W);
	} else {
		const W = [{ x: d.x, y: u.y }],
			Y = [{ x: u.x, y: d.y }];
		if ((f === 'x' ? (m = a.x === g ? Y : W) : (m = a.y === g ? W : Y), t === r)) {
			const v = Math.abs(e[f] - n[f]);
			if (v <= s) {
				const S = Math.min(s - 1, s - v);
				a[f] === g ? (E[f] = (d[f] > e[f] ? -1 : 1) * S) : (O[f] = (u[f] > n[f] ? -1 : 1) * S);
			}
		}
		if (t !== r) {
			const v = f === 'x' ? 'y' : 'x',
				...
				y = d[v] > u[v],
				k = d[v] < u[v];
			((a[f] === 1 && ((!S && y) || (S && k))) || (a[f] !== 1 && ((!S && k) || (S && y)))) &&
				(m = f === 'x' ? W : Y);
		}
		const Q = { x: d.x + E.x, y: d.y + E.y },
			M = { x: u.x + O.x, y: u.y + O.y },
			p = Math.max(Math.abs(Q.x - m[0].x), Math.abs(M.x - m[0].x)),
			N = Math.max(Math.abs(Q.y - m[0].y), Math.abs(M.y - m[0].y));
		p >= N ? ((x = (Q.x + M.x) / 2), (w = m[0].y)) : ((x = m[0].x), (w = (Q.y + M.y) / 2));
	}
	const H = { x: d.x + E.x, y: d.y + E.y },
		L = { x: u.x + O.x, y: u.y + O.y };
	return [
		[
			e,
			...(H.x !== m[0].x || H.y !== m[0].y ? [H] : []),
			...m,
			...(L.x !== m[m.length - 1].x || L.y !== m[m.length - 1].y ? [L] : []),
			n,
		],
		x,
		w,
...
function Xd(e, t, n, r) {
	const o = Math.min(ui(e, t) / 2, ui(t, n) / 2, r),
		{ x: s, y: i } = t;
...
function xo({
	...
	let w = `M${h[0].x} ${h[0].y}`;
	for (let E = 1; E < h.length - 1; E++) w += Xd(h[E - 1], h[E], h[E + 1], i);
...
function Wd(e) {
	...
	const r = t.internals.handleBounds || fi(t.handles),
		o = n.internals.handleBounds || fi(n.handles),
		s = hi((r == null ? void 0 : r.source) ?? [], e.sourceHandle),
		i = hi(
			e.connectionMode === Kt.Strict
	...
	for (const o of e.values())
		if (o.parentId) ko(o, e, t, r);
			...
			const s = Nn(o, r.nodeOrigin),
				i = Xt(o.extent) ? o.extent : r.nodeExtent,
				a = kt(s, i, Mt(o));
...
function Jd(e, t, n, r = {}) {
	...
	const o = bo(Gd, r),
		s = { i: 0 },
		i = new Map(t),
		a = o != null && o.elevateNodesOnSelect && !_o(o.zIndexMode) ? ks : 0;
	let l = e.length > 0,
		d = !1;
	t.clear(), n.clear();
	for (const f of e) {
		...
		if (o.checkEquality && f === (g == null ? void 0 : g.internals.userNode)) t.set(f.id, g);
			...
			const m = Nn(f, o.nodeOrigin),
				x = Xt(f.extent) ? f.extent : o.nodeExtent,
				w = kt(m, x, Mt(f));
			(g = {
				...o.defaults,
				...f,
...
function Ss(e, t, n) {
	const r = it(e.zIndex) ? e.zIndex : 0;
...
function $d(e, t, n, r, o, s) {
	const { x: i, y: a } = t.internals.positionAbsolute,
		l = Mt(e),
		d = Nn(e, n),
		u = Xt(e.extent) ? kt(d, e.extent, l) : d;
	let h = kt({ x: i + u.x, y: a + u.y }, r, l);
	e.extent === 'parent' && (h = gs(h, l, t));
	const f = Ss(e, o, s),
		g = t.internals.z ?? 0;
...
function ef(e, t, n, r = [0, 0]) {
	...
	for (const a of e) {
		...
		if (!l) continue;
		const d = ((i = s.get(a.parentId)) == null ? void 0 : i.expandedRect) ?? Ft(l),
			u = Pd(d, a.rect);
			...
			s.forEach(({ expandedRect: a, parent: l }, d) => {
				...
				(g > 0 || m > 0 || E || O) &&
					(o.push({
						id: d,
						type: 'position',
						position: { x: l.position.x - g + E, y: l.position.y - m + O },
					}),
					(P = n.get(d)) == null ||
						P.forEach((A) => {
							e.some((H) => H.id === A.id) ||
					...
					(h.width < a.width || h.height < a.height || g || m) &&
						o.push({
							...
							type: 'dimensions',
							setAttributes: !0,
							dimensions: { width: x + (g ? f[0] * g - E : 0), height: w + (m ? f[1] * m - O : 0) },
						});
			}),
		o
	);
		...
		if (x.width && x.height && (w || !m.internals.handleBounds || g.force)) {
			...
			const H = {
				...
				internals: {
					...
					positionAbsolute: A,
					handleBounds: {
						source: ai('source', g.nodeElement, O, h, m.id),
						target: ai('target', g.nodeElement, O, h, m.id),
					},
				},
			};
			t.set(m.id, H),
				...
				w &&
					...
					m.expandParent &&
						m.parentId &&
						f.push({ id: m.id, parentId: m.parentId, rect: Ft(H, o) }));
		}
	}
	if (f.length > 0) {
		const g = ef(f, t, n, o);
...
function rf(e, t, n) {
	...
	for (const r of n) {
		const { source: o, target: s, sourceHandle: i = null, targetHandle: a = null } = r,
			...
			d = `${o}-${i}--${s}-${a}`,
			u = `${s}-${a}--${o}-${i}`;
		gi('source', l, u, e, o, i), gi('target', l, d, e, s, a), t.set(r.id, r);
	}
}
function Es(e, t) {
	if (!e.parentId) return !1;
	const n = t.get(e.parentId);
	return n ? (n.selected ? !0 : Es(n, t)) : !1;
}
function vi(e, t, n) {
	var o;
	let r = e;
...
function af({ onNodeMouseDown: e, getStoreItems: t, onDragStart: n, onDrag: r, onDragStop: o }) {
	...
	function w({
		...
		function W({ x: p, y: N }) {
			...
			const V = a.size > 1,
				X = V && S ? Qr(dr(a)) : null,
				J = V && k ? sf({ dragItems: a, snapGrid: y, x: p, y: N }) : null;
			for (const [q, ee] of a) {
				if (!v.has(q)) continue;
				let oe = { x: p - ee.distance.x, y: N - ee.distance.y };
				k && (oe = J ? { x: Math.round(oe.x + J.x), y: Math.round(oe.y + J.y) } : Pn(oe, y));
				let ge = null;
				if (V && S && !ee.extent && X) {
					const { positionAbsolute: ce } = ee.internals,
						xe = ce.x - X.x + S[0][0],
						Me = ce.x + ee.measured.width - X.x2 + S[1][0],
						Ae = ce.y - X.y + S[0][1],
						Ie = ce.y + ee.measured.height - X.y2 + S[1][1];
					ge = [
						[xe, Ae],
						[Me, Ie],
					];
				}
				const { position: re, positionAbsolute: we } = hs({
					nodeId: q,
					nextPosition: oe,
					nodeLookup: v,
					nodeExtent: ge || S,
				...
				(D = D || ee.position.x !== re.x || ee.position.y !== re.y),
					(ee.position = re),
					(ee.internals.positionAbsolute = we);
			}
			if (((m = m || D), !!D && (Z(a, !0), x && (r || z || (!L && T))))) {
				const [q, ee] = Pr({ nodeId: L, dragItems: a, nodeLookup: v });
				r == null || r(x, a, q, ee), z == null || z(x, q, ee), L || T == null || T(x, ee);
			}
		}
		async function Y() {
			if (!u) return;
			const { transform: p, panBy: N, autoPanSpeed: v, autoPanOnNodeDrag: S } = t();
			if (!S) {
		...
		function Q(p) {
			...
			(h = !0),
				(!z || !H) && !v && L && (((V = N.get(L)) != null && V.selected) || Z()),
				H && z && L && (e == null || e(L));
			const D = Nr(p.sourceEvent, { transform: y, snapGrid: k, snapToGrid: I, containerBounds: u });
			if (((s = D), (a = of(N, S, D, L)), a.size > 0 && (n || T || (!L && K)))) {
				const [X, J] = Pr({ nodeId: L, dragItems: a, nodeLookup: N });
				n == null || n(p.sourceEvent, a, X, J),
					T == null || T(p.sourceEvent, X, J),
					L || K == null || K(p.sourceEvent, J);
			}
		}
		const M = Cc()
			.clickDistance(F)
			.on('start', (p) => {
				const { domNode: N, nodeDragThreshold: v, transform: S, snapGrid: y, snapToGrid: k } = t();
				(u = (N == null ? void 0 : N.getBoundingClientRect()) || null),
					(g = !1),
					(m = !1),
					(x = p.sourceEvent),
					v === 0 && Q(p),
					(s = Nr(p.sourceEvent, { transform: S, snapGrid: y, snapToGrid: k, containerBounds: u })),
			...
			.on('drag', (p) => {
				const {
					...
					z = Nr(p.sourceEvent, { transform: v, snapGrid: S, snapToGrid: y, containerBounds: u });
				if (
					((x = p.sourceEvent),
					...
					if ((!l && N && h && ((l = !0), Y()), !h)) {
						const T = Ze(p.sourceEvent, u),
							K = T.x - d.x,
							Z = T.y - d.y;
						Math.sqrt(K * K + Z * Z) > k && Q(p);
					}
					(s.x !== z.xSnapped || s.y !== z.ySnapped) &&
						a &&
						h &&
						((d = Ze(p.sourceEvent, u)), W(z));
				}
			})
			.on('end', (p) => {
				if (!h || g) {
				...
				if (((l = !1), (h = !1), cancelAnimationFrame(i), a.size > 0)) {
					...
					if ((m && (v(a, !1), (m = !1)), o || S || (!L && y))) {
						const [k, I] = Pr({ nodeId: L, dragItems: a, nodeLookup: N, dragging: !1 });
						o == null || o(p.sourceEvent, a, k, I),
							S == null || S(p.sourceEvent, k, I),
							L || y == null || y(p.sourceEvent, I);
					}
				}
			})
			.filter((p) => {
				const N = p.target;
				return !p.button && (!O || !vi(N, `.${O}`, A)) && (!P || vi(N, P, A));
			});
		f.call(M);
	}
	function E() {
	...
	return { update: w, destroy: E };
}
function lf(e, t, n) {
	const r = [],
		o = { x: e.x - n, y: e.y - n, width: n * 2, height: n * 2 };
	for (const s of t.values()) pn(o, Ft(s)) > 0 && r.push(s);
	return r;
}
const cf = 250;
function uf(e, t, n, r) {
	...
	for (const d of i) {
		...
		for (const h of u) {
			...
			const { x: f, y: g } = St(d, h, h.position, !0),
...
function Cs(e, t, n, r, o, s = !1) {
	...
	return l && s ? { ...l, ...St(i, l, l.position, !0) } : l;
}
function Ms(e, t) {
	return (
		e ||
...
function ff(
	...
	function D() {
		if (!u || !S) return;
		const [re, we] = mo(I, S, L);
		f({ x: re, y: we }), (Q = requestAnimationFrame(D));
	}
	const V = { ...k, nodeId: o, type: v, position: k.position },
		X = l.get(o);
	let q = {
		inProgress: !0,
		isValid: null,
		from: St(X, V, ne.Left, !0),
		fromHandle: V,
		fromPosition: V.position,
		fromNode: X,
		to: I,
		toHandle: null,
		toPosition: ri[V.position],
		toNode: null,
		pointer: I,
	};
	function ee() {
		(y = !0), P(q), m == null || m(e, { nodeId: o, handleId: r, handleType: v });
	}
	F === 0 && ee();
	function oe(re) {
		if (!y) {
			const { x: Ie, y: ie } = Ze(re),
				de = Ie - p,
				ke = ie - N;
			if (!(de * de + ke * ke > F * F)) return;
			ee();
		}
		if (!H() || !V) {
			ge(re);
		...
		const we = A();
		(I = Ze(re, S)), (M = uf(Zt(I, we, !1, [1, 1]), n, l, V)), z || (D(), (z = !0));
		const ce = Ps(re, {
			handle: M,
			connectionMode: t,
			fromNodeId: o,
		...
		(Z = ce.handleDomNode), (T = ce.connection), (K = df(!!M, ce.isValid));
		const xe = l.get(o),
			Me = xe ? St(xe, V, ne.Left, !0) : q.from,
			Ae = {
				...q,
				from: Me,
				isValid: K,
				to: ce.toHandle && K ? Yt({ x: ce.toHandle.x, y: ce.toHandle.y }, we) : I,
				toHandle: ce.toHandle,
				toPosition: K && ce.toHandle ? ce.toHandle.position : ri[V.position],
	...
	function ge(re) {
		if (!('touches' in re && re.touches.length > 0)) {
			if (y) {
				(M || Z) && T && K && (x == null || x(T));
				const { inProgress: we, ...ce } = q,
					xe = { ...ce, toPosition: q.toHandle ? q.toPosition : null };
				w == null || w(re, xe), s && (O == null || O(re, xe));
			}
			g(),
				...
				(T = null),
				(Z = null),
				Y.removeEventListener('mousemove', oe),
				Y.removeEventListener('mouseup', ge),
				Y.removeEventListener('touchmove', oe),
				Y.removeEventListener('touchend', ge);
		}
	}
	Y.addEventListener('mousemove', oe),
		Y.addEventListener('mouseup', ge),
		Y.addEventListener('touchmove', oe),
...
function Ps(
	...
	const h = s === 'target',
		...
		E = { handleDomNode: w, isValid: !1, connection: null, toHandle: null };
	if (w) {
		const O = Ms(void 0, w),
			P = w.getAttribute('data-nodeid'),
			A = w.getAttribute('data-handleid'),
			H = w.classList.contains('connectable'),
			L = w.classList.contains('connectableend');
		if (!P || !O) return E;
		const F = {
			source: h ? P : r,
			sourceHandle: h ? A : o,
		...
		const Y =
			H &&
			L &&
			(n === Kt.Strict ? (h && O === 'source') || (!h && O === 'target') : P !== r || A !== o);
		(E.isValid = Y && d(F)), (E.toHandle = Cs(P, O, A, u, n, !0));
	}
	return E;
}
const yi = { onPointerDown: ff, isValid: Ps },
	gr = (e) => ({ x: e.x, y: e.y, zoom: e.k }),
	Ar = ({ x: e, y: t, zoom: n }) => ur.translate(e, t).scale(n),
	Tt = (e, t) => e.target.closest(`.${t}`),
	As = (e, t) => t === 2 && Array.isArray(e) && e.includes(2),
...
function gf({
	...
	return (u) => {
		if (Tt(u, t)) return u.ctrlKey && u.preventDefault(), !1;
		...
		let g = o === Dt.Vertical ? 0 : u.deltaX * f,
			m = o === Dt.Horizontal ? 0 : u.deltaY * f;
		!er() && u.shiftKey && o !== Dt.Vertical && ((g = u.deltaY * f), (m = 0)),
			r.translateBy(n, -(g / h) * s, -(m / h) * s, { internal: !0 });
		const x = gr(n.property('__zoom'));
...
function xf({
	...
	return (h) => {
		...
		if (
			h.button === 1 &&
			h.type === 'mousedown' &&
			(Tt(h, `${d}-flow__node`) || Tt(h, `${d}-flow__edge`))
		)
			return !0;
		if (
			(!r && !f && !o && !s && !n) ||
...
function pf({
	...
	const d = {
		...
		f = Xe(e).call(h);
	O(
		{ x: o.x, y: o.y, zoom: Bt(o.zoom, t, n) },
		[
			[0, 0],
			[u.width, u.height],
		],
	...
	async function x(M, p) {
		return f
			? new Promise((N) => {
					h == null ||
						h.interpolate((p == null ? void 0 : p.interpolate) === 'linear' ? vn : Kn).transform(
	...
	function w({
		...
		const oe = S && !D && !v;
		h.clickDistance(ee ? 1 / 0 : !it(q) || q < 0 ? 0 : q);
		const ge = oe
			? gf({
					zoomPanValues: d,
					noWheelClassName: M,
		...
		h.filter(xe), Z ? f.on('dblclick.zoom', m) : f.on('dblclick.zoom', null);
	}
	function E() {
		h.on('zoom', null);
	}
	async function O(M, p, N) {
		const v = Ar(M),
			S = h == null ? void 0 : h.constrain()(v, p, N);
		return S && (await x(S)), S;
	}
	...
	function H() {
		const M = f ? us(f.node()) : { x: 0, y: 0, k: 1 };
		return { x: M.x, y: M.y, zoom: M.k };
	}
	async function L(M, p) {
		return f
			? new Promise((N) => {
					h == null ||
						h.interpolate((p == null ? void 0 : p.interpolate) === 'linear' ? vn : Kn).scaleTo(
							zr(f, p == null ? void 0 : p.duration, p == null ? void 0 : p.ease, () => N(!0)),
							M,
						);
				})
	...
	async function F(M, p) {
		return f
			? new Promise((N) => {
					h == null ||
						h.interpolate((p == null ? void 0 : p.interpolate) === 'linear' ? vn : Kn).scaleBy(
							zr(f, p == null ? void 0 : p.duration, p == null ? void 0 : p.ease, () => N(!0)),
							M,
						);
				})
...
function Et(e, t) {
	...
	Ti(() => {
		if (t.onconnect || t.ondisconnect) {
			...
			if (m && !bd(p, m)) {
				const N = p ?? new Map();
				oi(m, N, t.ondisconnect), oi(N, m, t.onconnect);
			}
			m = new Map(p);
		}
	});
	const x = b(() => {
			...
			const { fromHandle: p, toHandle: N, isValid: v } = f.connection,
				S = p && p.nodeId === l && p.type === r() && p.id === n(),
				y = N && N.nodeId === l && N.type === r() && N.id === n(),
				k =
					f.connectionMode === Kt.Strict
		...
		p.currentTarget &&
			...
			yi.onPointerDown(p, {
				...
				isValidConnection:
					...
					((...v) => {
						var S;
						return ((S = f.isValidConnection) == null ? void 0 : S.call(f, ...v)) ?? !0;
					}),
				...
				onConnectEnd: (...v) => {
					var S;
					return (S = f.onconnectend) == null ? void 0 : S.call(f, ...v);
				},
	...
	function W(p) {
		...
		if (!f.clickConnectStartHandle) {
			(Z = f.onclickconnectstart) == null ||
				Z.call(f, p, { nodeId: l, handleId: n(), handleType: r() }),
				(f.clickConnectStartHandle = { nodeId: l, type: r(), id: n() });
			return;
		}
		const N = ms(p.target),
			v = t.isValidConnection ?? f.isValidConnection,
			{ connectionMode: S, clickConnectStartHandle: y, flowId: k, nodeLookup: I } = f,
			{ connection: z, isValid: T } = yi.isValid(p, {
		...
		T && z && L(z);
		const K = structuredClone(Di(f.connection));
		delete K.inProgress,
			(K.toPosition = K.toHandle ? K.toHandle.position : null),
			(D = f.onclickconnectend) == null || D.call(f, p, K),
	...
	gt(Y, () => ({
		...
		onmousedown: F,
		ontouchstart: F,
		onclick: f.clickConnect ? W : void 0,
		onkeypress: Q,
		style: t.style,
		role: 'button',
		...
		[to]: {
			...
			connectable: c(h),
			connectionindicator:
				c(h) && (!c(E) || c(A)) && (c(E) || f.clickConnectStartHandle ? i() : s()),
		},
	}));
	var M = $(Y);
	Ye(M, () => t.children ?? Wt), j(Y), G(e, Y), le();
}
var zf = se('<!> <!>', 1);
function Ts(e, t) {
	ae(t, !0);
...
function vr(e, t) {
	...
	ye(() => {
		be(s, 'id', t.id),
			be(s, 'd', t.path),
			ht(s, 0, no(['svelte-flow__edge-path', t.class])),
...
function Zf(e, t) {
	ae(t, !0);
	const n = b(() =>
			_s({ sourceX: t.sourceX, sourceY: t.sourceY, targetX: t.targetX, targetY: t.targetY }),
		),
		r = b(() => Sn(c(n), 3)),
		o = b(() => c(r)[0]),
		s = b(() => c(r)[1]),
...
function xi(e) {
	...
	for (const h of t) {
		...
		if (!f || !g) continue;
		if (a) {
			const { visibleNodes: w, transform: E, width: O, height: P } = e;
			if (Ld({ sourceNode: f, targetNode: g, width: O, height: P, transform: E }))
...
const $f = vs(),
	Os = { input: If, output: Df, default: Ts, group: Hf },
	Ds = { straight: Zf, smoothstep: Wf, default: Is, step: qf };
...
function th(e) {
	...
	class t {
		constructor() {
			...
			B(this, r, he(null));
			B(this, o, he(null));
			B(this, s, he(e.width ?? 0));
			B(this, i, he(e.height ?? 0));
			B(this, a, he(e.props.zIndexMode ?? 'basic'));
			B(
				this,
				l,
				b(() => {
			...
			B(
				...
				b(() => {
					...
					if (Fs) {
						const { viewport: mr, width: Co, height: Mo } = this,
							No = [mr.x, mr.y, mr.zoom];
						(An = jf(Ke, No, Co, Mo)),
							(yr = xi({
								...Eo,
								onlyRenderVisible: !0,
					...
					} else (An = this.nodeLookup), (yr = xi(Eo));
					return { nodes: An, edges: yr };
				}),
			);
			B(
				this,
			...
			B(
				this,
				q,
				b(() => ({ ...Os, ...e.props.nodeTypes })),
			);
			B(
				this,
				ee,
				b(() => ({ ...Ds, ...e.props.edgeTypes })),
			);
			B(
				this,
				oe,
			...
			B(
				...
				b(() =>
					this._connection.inProgress
						? {
								...this._connection,
								to: Zt(this._connection.to, [this.viewport.x, this.viewport.y, this.viewport.zoom]),
							}
						: this._connection,
				),
			);
			B(
				this,
				Ae,
				b(() => e.props.connectionMode ?? Kt.Strict),
			);
			B(
				this,
				Ie,
...
function rh(e) {
	...
	const s = (M, p = !1) => {
		t.nodes = t.nodes.map((N) => {
			if (t.connection.inProgress && t.connection.fromNode.id === N.id) {
				...
				S &&
					(t.connection = { ...t.connection, from: St(S, t.connection.fromHandle, ne.Left, !0) });
			}
			const v = M.get(N.id);
	...
	function i(M) {
		...
		const v = new Map();
		for (const I of p) {
			const z = (S = t.nodeLookup.get(I.id)) == null ? void 0 : S.internals.userNode;
			if (!z) continue;
			const T = { ...z };
			switch (I.type) {
				case 'dimensions': {
	...
	function x(M, p = null) {
		let N = !1;
		const v = M.map((S) =>
			(p ? p.has(S.id) : !0) && S.selected ? ((N = !0), { ...S, selected: !1 }) : S,
		);
		return [N, v];
	}
	function w(M) {
		const p = M != null && M.nodes ? new Set(M.nodes.map((I) => I.id)) : null,
			[N, v] = x(t.nodes, p);
		N && (t.nodes = v);
		const S = M != null && M.edges ? new Set(M.edges.map((I) => I.id)) : null,
			[y, k] = x(t.edges, S);
		y && (t.edges = k);
	}
	function E(M) {
	...
	function H(M, p) {
		...
		for (const V of y.values()) {
			if (!(V.selected && (V.draggable || (k && typeof V.draggable > 'u')))) continue;
			let J = { x: V.internals.positionAbsolute.x + Z, y: V.internals.positionAbsolute.y + D };
			v && (J = Pn(J, v));
			const { position: q, positionAbsolute: ee } = hs({
				nodeId: V.id,
				nextPosition: J,
				nodeLookup: y,
				nodeExtent: N,
			...
			(V.position = q), (V.internals.positionAbsolute = ee), z.set(V.id, V);
		}
		s(z);
	}
	function L(M) {
...
function ah(e, t) {
	...
	function E(y) {
		...
		(V = (D = y.target) == null ? void 0 : D.setPointerCapture) == null || V.call(D, y.pointerId),
			(g = !1),
			(w = !1);
		const { x: T, y: K } = Ze(y, a),
			Z = Zt({ x: T, y: K }, [n().viewport.x, n().viewport.y, n().viewport.zoom]);
		n((n().selectionRect = { width: 0, height: 0, startX: Z.x, startY: Z.y, x: T, y: K }), !0),
			k || (y.stopPropagation(), y.preventDefault());
	}
	function O(y, k) {
		var V, X, J;
		if (
			((V = n().selectionRect) == null ? void 0 : V.startX) === void 0 ||
			n().selectionRect.startY === void 0
		)
			return;
		const I = {
				x: (X = n().selectionRect) == null ? void 0 : X.startX,
				y: (J = n().selectionRect) == null ? void 0 : J.startY,
			},
			z = Yt(I, [n().viewport.x, n().viewport.y, n().viewport.zoom]),
			T = {
				startX: I.x,
				startY: I.y,
				x: y < z.x ? y : z.x,
		...
		d = new Set();
		for (const q of l) {
			const ee = n().connectionLookup.get(q);
			if (ee)
				for (const { edgeId: oe } of ee.values()) {
					const ge = n().edgeLookup.get(oe);
					ge && (ge.selectable ?? D) && d.add(oe);
				}
		}
		_i(K, l) || n((n().nodes = n().nodes.map(bi(l))), !0),
			_i(Z, d) || n((n().edges = n().edges.map(bi(d))), !0),
	...
	Ye(S, () => t.children),
		...
		ye(
			(y) => (p = ht(M, 1, 'svelte-flow__pane svelte-flow__container', null, p, y)),
			[
				() => ({
		...
		gn(
			...
			function (...y) {
				var k;
				(k = c(f) ? E : void 0) == null || k.apply(this, y);
			},
			!0,
		),
		...
		Fe('pointerup', M, function (...y) {
			var k;
			(k = c(f) ? L : void 0) == null || k.apply(this, y);
		}),
...
function fh(e, t) {
	...
	ye(() => {
		be(r, 'id', `${Hs}-${t.store.flowId}`),
			...
			be(s, 'id', `${Rs}-${t.store.flowId}`),
			Ce(i, t.store.ariaLabelConfig['edge.a11yDescription.default']);
	}),
		G(e, n),
		le();
}
const Hs = 'svelte-flow__node-desc',
	Rs = 'svelte-flow__edge-desc',
	hh = 'svelte-flow__aria-live';
var gh = se('<div><!></div>');
function vh(e, t) {
	ae(t, !0);
	const n = U(t, 'store', 15),
		r = b(() => Te(t.node.data, () => ({}), !0)),
		o = b(() => Te(t.node.selected, !1)),
		s = b(() => t.node.draggable),
		i = b(() => t.node.selectable),
		a = b(() => Te(t.node.deletable, !0)),
		l = b(() => t.node.connectable),
		d = b(() => t.node.focusable),
		u = b(() => Te(t.node.hidden, !1)),
		h = b(() => Te(t.node.dragging, !1)),
		f = b(() => Te(t.node.style, '')),
		g = b(() => t.node.class),
		m = b(() => Te(t.node.type, 'default')),
		x = b(() => t.node.parentId),
		w = b(() => t.node.sourcePosition),
		E = b(() => t.node.targetPosition),
		O = b(() => Te(t.node.measured, () => ({ width: 0, height: 0 }), !0).width),
		P = b(() => Te(t.node.measured, () => ({ width: 0, height: 0 }), !0).height),
		A = b(() => t.node.initialWidth),
		H = b(() => t.node.initialHeight),
		L = b(() => t.node.width),
		F = b(() => t.node.height),
		W = b(() => t.node.dragHandle),
		Y = b(() => Te(t.node.internals.z, 0)),
		Q = b(() => t.node.internals.positionAbsolute.x),
		M = b(() => t.node.internals.positionAbsolute.y),
		p = b(() => t.node.internals.userNode),
		{ id: N } = t.node,
		v = b(() => c(s) ?? n().nodesDraggable),
		S = b(() => c(i) ?? n().elementsSelectable),
	...
	let Z = b(() => K(N)),
		...
		J = c(w),
		q = c(E),
		ee = b(() => n().nodeTypes[c(m)] ?? Ts),
		oe = b(() => n().ariaLabelConfig),
		ge = {
			get value() {
				return c(y);
			},
	...
	Sf(N), Cf(ge);
	const re = b(() => {
		const ie = c(O) === void 0 ? (c(L) ?? c(A)) : c(L),
			de = c(P) === void 0 ? (c(F) ?? c(H)) : c(F);
		if (!(ie === void 0 && de === void 0 && c(f) === void 0))
			return `${c(f)};${ie ? `width:${tt(ie)};` : ''}${de ? `height:${tt(de)};` : ''}`;
	});
	st(() => {
		(c(m) !== X || c(w) !== J || c(E) !== q) &&
			c(D) !== null &&
			requestAnimationFrame(() => {
				c(D) !== null &&
					n().updateNodeInternals(new Map([[N, { id: N, nodeElement: c(D), force: !0 }]]));
			}),
			(X = c(m)),
			(J = c(w)),
			(q = c(E));
		...
		st(() => {
			t.resizeObserver &&
				(!c(z) || c(D) !== V) &&
				(V && t.resizeObserver.unobserve(V), c(D) && t.resizeObserver.observe(c(D)), (V = c(D)));
		}),
		ir(() => {
			var ie;
			V && ((ie = t.resizeObserver) == null || ie.unobserve(V));
		});
	function we(ie) {
		var de;
		c(S) &&
			...
			(de = t.onnodeclick) == null || de.call(t, { node: c(p), event: ie });
	}
	function ce(ie) {
		if (!(ws(ie) || n().disableKeyboardA11y))
			if (ds.includes(ie.key) && c(S)) {
				const de = ie.key === 'Escape';
				n().handleNodeSelection(N, de, c(D));
			} else
				c(v) &&
					t.node.selected &&
					Object.hasOwn(tr, ie.key) &&
					(ie.preventDefault(),
					n(
					...
					n().moveSelectedNodes(tr[ie.key], ie.shiftKey ? 4 : 1));
	}
	const xe = () => {
		var Se;
		if (
			...
			!((Se = c(D)) != null && Se.matches(':focus-visible'))
		)
			return;
		const { width: ie, height: de, viewport: ke } = n();
		yo(new Map([[N, t.node]]), { x: 0, y: 0, width: ie, height: de }, [ke.x, ke.y, ke.zoom], !0)
			.length > 0 ||
			n().setCenter(
	...
	var Ie = (ie) => {
		...
		gt(de, () => ({
			...
			onpointerenter: t.onnodepointerenter
				? (fe) => t.onnodepointerenter({ node: c(p), event: fe })
				: void 0,
			onpointerleave: t.onnodepointerleave
				? (fe) => t.onnodepointerleave({ node: c(p), event: fe })
				: void 0,
			onpointermove: t.onnodepointermove
				? (fe) => t.onnodepointermove({ node: c(p), event: fe })
				: void 0,
			oncontextmenu: t.onnodecontextmenu
				? (fe) => t.onnodecontextmenu({ node: c(p), event: fe })
				: void 0,
			onkeydown: c(T) ? ce : void 0,
			onfocus: c(T) ? xe : void 0,
			tabIndex: c(T) ? 0 : void 0,
			role: t.node.ariaRole ?? (c(T) ? 'group' : void 0),
			'aria-label': t.node.ariaLabel,
			'aria-roledescription': 'node',
			'aria-describedby': n().disableKeyboardA11y ? void 0 : `${Hs}-${n().flowId}`,
			...
			[or]: {
				'z-index': c(Y),
				transform: `translate(${c(Q) ?? ''}px, ${c(M) ?? ''}px)`,
		...
		oo(
			...
			De(
				...
				() => ({
					...
					onDrag: (fe, Se, Oe, Ne) => {
						var Pe;
						(Pe = t.onnodedrag) == null || Pe.call(t, { event: fe, targetNode: Oe, nodes: Ne });
					},
					onDragStart: (fe, Se, Oe, Ne) => {
						var Pe;
						(Pe = t.onnodedragstart) == null ||
							Pe.call(t, { event: fe, targetNode: Oe, nodes: Ne });
					},
					onDragStop: (fe, Se, Oe, Ne) => {
						var Pe;
						(Pe = t.onnodedragstop) == null || Pe.call(t, { event: fe, targetNode: Oe, nodes: Ne });
					},
					store: n(),
				}),
			),
...
var wh = _e('<svg class="svelte-flow__edge-wrapper"><g><!></g></svg>');
function xh(e, t) {
	ae(t, !0);
	const n = b(() => t.edge.id),
		r = b(() => t.edge.source),
		...
		h = b(() => Te(t.edge.animated, !1)),
		f = b(() => Te(t.edge.selected, !1)),
		g = b(() => t.edge.label),
		m = b(() => t.edge.labelStyle),
		x = b(() => Te(t.edge.data, () => ({}), !0)),
		w = b(() => t.edge.style),
		E = b(() => t.edge.interactionWidth),
		O = b(() => Te(t.edge.type, 'default')),
		P = b(() => t.edge.sourceHandle),
		A = b(() => t.edge.targetHandle),
		H = b(() => t.edge.markerStart),
		L = b(() => t.edge.markerEnd),
		F = b(() => t.edge.selectable),
		W = b(() => t.edge.focusable),
		Y = b(() => Te(t.edge.deletable, !0)),
		Q = b(() => t.edge.hidden),
		M = b(() => t.edge.zIndex),
		p = b(() => t.edge.class),
	...
	Nf(c(n));
	let v = null,
		S = b(() => c(F) ?? t.store.elementsSelectable),
		y = b(() => c(W) ?? t.store.edgesFocusable),
		k = b(() => t.store.edgeTypes[c(O)] ?? Is),
		I = b(() => (c(H) ? `url('#${Jr(c(H), t.store.flowId)}')` : void 0)),
		z = b(() => (c(L) ? `url('#${Jr(c(L), t.store.flowId)}')` : void 0));
	function T(J) {
		var ee;
		const q = t.store.edgeLookup.get(c(n));
		q &&
			(c(S) && t.store.handleEdgeSelection(c(n)),
			(ee = t.onedgeclick) == null || ee.call(t, { event: J, edge: q }));
	}
	function K(J, q) {
		const ee = t.store.edgeLookup.get(c(n));
		ee && q({ event: J, edge: ee });
	}
	function Z(J) {
		if (!t.store.disableKeyboardA11y && ds.includes(J.key) && c(S)) {
			const { unselectNodesAndEdges: q, addSelectedEdges: ee } = t.store;
			J.key === 'Escape' ? (v == null || v.blur(), q({ edges: [t.edge] })) : ee([c(n)]);
		}
	}
	var D = Re(),
		V = me(D);
	var X = (J) => {
		...
		gt(oe, () => ({
			...
			'aria-describedby': c(y) ? `${Rs}-${t.store.flowId}` : void 0,
			role: t.edge.ariaRole ?? (c(y) ? 'group' : 'img'),
			'aria-roledescription': 'edge',
			onkeydown: c(y) ? Z : void 0,
			tabindex: c(y) ? 0 : void 0,
			...t.edge.domAttributes,
			[to]: { animated: c(h), selected: c(f), selectable: c(S) },
		}));
		var ge = $(oe);
		oo(
			ge,
...
function Eh(e, t) {
	...
	ve(l, (h) => {
		t.type === jn.Arrow ? h(d) : t.type === jn.ArrowClosed && h(u, 1);
	});
	j(a),
		ye(() => {
			be(a, 'id', t.id),
...
function Ls(e, t) {
	...
	var d = (u) => {
		...
		ye(
			...
			[
				() => ({
					width: typeof o() == 'string' ? o() : tt(o()),
					height: typeof s() == 'string' ? s() : tt(s()),
...
function Ah(e, t) {
	...
	const r = b(() => {
		if (t.store.selectionRectMode === 'nodes') {
			t.store.nodes;
			const h = dr(t.store.nodeLookup, { filter: (f) => !!f.selected });
	...
	function i(h) {
		Object.hasOwn(tr, h.key) &&
			(h.preventDefault(), t.store.moveSelectedNodes(tr[h.key], h.shiftKey ? 4 : 1));
	}
	var a = Re(),
		l = me(a);
	var d = (h) => {
			...
			let g;
			var m = $(f);
			Ls(m, { width: '100%', height: '100%', x: 0, y: 0 }),
				j(f),
				De(
					f,
					(x, w) => (Ht == null ? void 0 : Ht(x, w)),
					() => ({
						disabled: !1,
						store: t.store,
						onDrag: (x, w, E, O) => {
				...
				ye(
					(x) => {
						ht(f, 1, no(['svelte-flow__selection-wrapper', t.store.noPanClass]), 'svelte-sf2y5e'),
		...
		u = b(() => t.store.selectionRectMode === 'nodes' && c(r) && it(c(r).x) && it(c(r).y));
	ve(l, (h) => {
		c(u) && h(d);
	});
	G(e, a), le();
	...
	function s(a) {
		...
		for (const h of l) {
			const f = { preventDefault: !1, enabled: !0, ...h },
				{ modifier: g, key: m, callback: x, preventDefault: w, enabled: E } = f;
			if (E) {
				if (a.key !== m) continue;
				if (g === null || g === !1) {
					if (d !== 0) continue;
					...
					let A = !1;
					for (const H of P)
						if ((Array.isArray(H) ? H : [H]).reduce((F, W) => F | zh(W), 0) === d) {
							A = !0;
							break;
						}
					if (!A) continue;
...
function Th() {
	const e = b(qt),
		t = (s) => {
			var d, u;
			const i = wi(s) ? s : c(e).nodeLookup.get(s.id),
				a = i.parentId
	...
	function n(s, i, a = { replace: !1 }) {
		c(e).nodes = ft(() => c(e).nodes).map((l) => {
			if (l.id === s) {
				...
				return a != null && a.replace && wi(d) ? d : { ...l, ...d };
			}
			return l;
		});
	}
	...
	return {
		...
		getNodes: (s) => (s === void 0 ? c(e).nodes : ki(c(e).nodeLookup, s)),
		getEdge: (s) => c(e).edgeLookup.get(s),
		getEdges: (s) => (s === void 0 ? c(e).edges : ki(c(e).edgeLookup, s)),
		setZoom: async (s, i) => {
			const a = c(e).panZoom;
		...
		deleteElements: async ({ nodes: s = [], edges: i = [] }) => {
			...
			return (
				a && (c(e).nodes = ft(() => c(e).nodes).filter((h) => !a.some(({ id: f }) => f === h.id))),
				l && (c(e).edges = ft(() => c(e).edges).filter((h) => !l.some(({ id: f }) => f === h.id))),
		...
		screenToFlowPosition: (s, i = { snapToGrid: !0 }) => {
			...
			const a = i.snapToGrid ? c(e).snapGrid : !1,
				...
				g = { x: s.x - h, y: s.y - f };
			return Zt(g, [l, d, u], a !== null, a || [1, 1]);
		},
...
function Ih(e, t) {
	...
	const n = U(t, 'store', 15),
		...
		o = U(t, 'multiSelectionKey', 19, () => (er() ? 'Meta' : 'Control')),
		s = U(t, 'deleteKey', 3, 'Backspace'),
		i = U(t, 'panActivationKey', 3, ' '),
		a = U(t, 'zoomActivationKey', 19, () => (er() ? 'Meta' : 'Control')),
		{ deleteElements: l } = Th();
	function d(x) {
...
var Oh = _e('<path fill="none" class="svelte-flow__connection-path"></path>'),
	Dh = _e('<svg class="svelte-flow__connectionline"><g><!></g></svg>');
function Hh(e, t) {
	ae(t, !0);
	const n = b(() => {
		...
		switch (t.type) {
			...
			case ut.Step:
			case ut.SmoothStep: {
				const [a] = xo({ ...i, borderRadius: t.type === ut.Step ? 0 : void 0 });
				return a;
			}
		}
	});
...
function Vs(e, t) {
	...
	const n = U(t, 'position', 3, 'top-right'),
		...
		o = b(() => `${n()}`.split('-'));
	var s = Lh();
	gt(s, (a) => ({ class: a, style: t.style, ...r }), [
		() => ['svelte-flow__panel', t.class, ...c(o)],
	]);
	var i = $(s);
	Ye(i, () => t.children ?? Wt), j(s), G(e, s), le();
}
var Vh = se(
...
function Fh(e, t) {
	...
	gt(
		...
		[() => ({ width: tt(t.width), height: tt(t.height) })],
		void 0,
		void 0,
		'svelte-mkap6j',
	);
...
function qh(e, t) {
	...
	let n = U(t, 'paneClickDistance', 3, 1),
		...
		o = U(t, 'panOnScrollMode', 19, () => Dt.Free),
		...
		m = U(t, 'connectionLineType', 19, () => ut.Bezier),
		x = U(t, 'nodes', 31, () => Do([])),
		w = U(t, 'edges', 31, () => Do([])),
		E = U(t, 'viewport', 15, void 0),
		O = Ct(t, Yh),
		P = rh({
			props: O,
			width: t.width,
	...
	A && A.setStore && A.setStore(P),
		...
		st(() => {
			...
			(L = ft(() => t.onselectionchange)) == null || L(H);
							...
							children: (S, y) => {
								...
								var z = te(I, 2);
								{
									const T = b(() => !!(P.selectionRect && P.selectionRectMode === 'user')),
										K = b(() => {
											var X;
											return (X = P.selectionRect) == null ? void 0 : X.width;
										}),
										Z = b(() => {
											var X;
											return (X = P.selectionRect) == null ? void 0 : X.height;
										}),
										D = b(() => {
											var X;
											return (X = P.selectionRect) == null ? void 0 : X.x;
										}),
										V = b(() => {
											var X;
											return (X = P.selectionRect) == null ? void 0 : X.y;
										});
									Ls(z, {
										get isVisible() {
											return c(T);
...
function hg(e, t) {
	...
	var m = (w) => {
		var E = dg(),
			O = $(E, !0);
		j(E), ye(() => Ce(O, t.data.description)), G(w, E);
	};
	ve(g, (w) => {
...
function mg(e, t) {
	...
	var x = (E) => {
		var O = vg(),
			P = $(O, !0);
		j(O), ye(() => Ce(P, t.data.description)), G(E, O);
	};
	ve(m, (E) => {
		t.data.description && E(x);
	});
	var w = te(m, 2);
	Et(w, {
		type: 'source',
...
function Mg(e, t) {
	...
	function m(D) {
		...
		R(l, ((D.clientX - X.left) / X.width) * 100), R(d, ((D.clientY - X.top) / X.height) * 100);
	}
	function x(D) {
		const V = D.detail ? D.detail.node : D.node;
		R(u, V, !0), R(h, !0), R(f, null);
	}
	function w() {
		R(h, !1), R(u, null);
	}
	const E = 'preview-workflow-1';
	const O = he(!1),
		P = he(!1),
		A = he(!1);
	async function H() {
		...
		try {
			...
			i.subscribe((X) => {
				...
				await kr(`/workflows/${E}/graph`, {
					method: 'PUT',
					body: JSON.stringify({ nodes: D, edges: V }),
				}),
				console.log('Workflow saved successfully');
		} catch (D) {
			console.error('Failed to save workflow:', D);
		} finally {
			setTimeout(() => R(O, !1), 500);
		}
	}
	async function L() {
		R(P, !0);
		try {
			const D = !c(A),
				V = await kr(`/workflows/${E}/deploy`, {
					method: 'POST',
					body: JSON.stringify({ isActive: D }),
				});
			R(A, V.isActive, !0);
		} catch (D) {
			console.error('Failed to deploy workflow:', D);
		} finally {
			setTimeout(() => R(P, !1), 500);
		}
	}
	async function F() {
		if (c(u)) {
			R(g, !0), R(f, null);
			try {
				const D = await kr('/engine/test-node', {
					method: 'POST',
					body: JSON.stringify({
						nodeId: c(u).id,
				...
				R(f, JSON.stringify(D, null, 2), !0);
			} catch (D) {
				R(f, JSON.stringify({ error: D.message }, null, 2), !0);
			} finally {
				R(g, !1);
			}
		}
	...
	var Z = (D) => {
		...
		var fe = (pe) => {
				var ze = bg(),
					lt = $(ze),
					mt = $(lt, !0);
				j(lt), j(ze), ye(() => Ce(mt, c(f))), G(pe, ze);
			},
			Se = (pe) => {
				var ze = _g();
				G(pe, ze);
		...
		j(Ne),
			j(Oe),
			ye(() => {
				Ce(ge, c(u).data.label), Ce(we, c(u).data.typeLabel), (Ne.disabled = c(g));
			}),
			Fe('click', ce, w),
			Ta(
				ie,
				() => c(u).data.label,
				(pe) => (c(u).data.label = pe),
			),
			Fe('click', Ne, F),
			G(D, V);
	};
	...
	j(T),
		...
		ye(() => {
			ht(
				...
				(M.disabled = c(O)),
				Ce(p, c(O) ? 'Saving...' : 'Save Workflow'),
				(N.disabled = c(P)),
				ht(
					N,
					1,
					`flex items-center gap-2 px-6 py-2 ${c(A) ? 'bg-primary/20 text-primary border-primary/50' : 'bg-white text-black border-transparent'} border rounded-full font-bold text-sm hover:scale-105 transition-all disabled:opacity-50 disabled:hover:scale-100 shadow-[0_0_20px_rgba(var(--primary),0.2)]`,
				),
				ht(
					I,
					1,
				...
				qe(T, `transform: translateX(${c(h) ? '0%' : '100%'})`);
		}),
		Fe('mousemove', W, m),
		Fe('click', M, H),
		Fe('click', N, L),
